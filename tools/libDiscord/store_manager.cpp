...
namespace discord
{
    ...
    Result StoreManager::GetEntitlement(Snowflake entitlementId, Entitlement* entitlement)
    {
        ...
        auto result = internal_->get_entitlement(internal_, entitlementId, reinterpret_cast<DiscordEntitlement*>(entitlement));
        return static_cast<Result>(result);
    }
    ...
    Result StoreManager::GetEntitlementAt(std::int32_t index, Entitlement* entitlement)
    {
        ...
        auto result = internal_->get_entitlement_at(internal_, index, reinterpret_cast<DiscordEntitlement*>(entitlement));
        return static_cast<Result>(result);
    }
    ...
    Result StoreManager::HasSkuEntitlement(Snowflake skuId, bool* hasEntitlement)
    {
        ...
        auto result = internal_->has_sku_entitlement(internal_, skuId, reinterpret_cast<bool*>(hasEntitlement));
        return static_cast<Result>(result);
    }
