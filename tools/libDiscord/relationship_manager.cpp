...
namespace discord
{
    ...
    Result RelationshipManager::Get(UserId userId, Relationship* relationship)
    {
        ...
        auto result = internal_->get(internal_, userId, reinterpret_cast<DiscordRelationship*>(relationship));
        return static_cast<Result>(result);
    }
    ...
    Result RelationshipManager::GetAt(std::uint32_t index, Relationship* relationship)
    {
        ...
        auto result = internal_->get_at(internal_, index, reinterpret_cast<DiscordRelationship*>(relationship));
        return static_cast<Result>(result);
    }
