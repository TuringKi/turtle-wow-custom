...
void CALLBACK StatusCallBack(HINTERNET hInternet, DWORD_PTR dwContext, DWORD dwInternetStatus, LPVOID lpvStatusInformation, DWORD dwStatusInformationLength)
{
...
#ifdef _DEBUG
    WriteLog(_T("StatusCallback (%d): info 0x%p size: %u, context: 0x%p"), dwInternetStatus, lpvStatusInformation, dwStatusInformationLength, dwContext);
#endif
    ...
    case INTERNET_STATUS_COOKIE_SENT:
        {
#ifdef _DEBUG
            WriteLog(_T("StatusCallback CookieSent: info 0x%p size: %u, context: 0x%p"), lpvStatusInformation, dwStatusInformationLength, dwContext);
#endif
        }
        break;
    case INTERNET_STATUS_COOKIE_RECEIVED:
        {
#ifdef _DEBUG
            WriteLog(_T("StatusCallback CookieReceived: info 0x%p size: %u, context: 0x%p"), lpvStatusInformation, dwStatusInformationLength, dwContext);
#endif
        }
        break;
    case INTERNET_STATUS_COOKIE_HISTORY:
        {
#ifdef _DEBUG
            WriteLog(_T("StatusCallback CookieHistory: info 0x%p size: %u, context: 0x%p"), lpvStatusInformation, dwStatusInformationLength, dwContext);
#endif
        }
        break;
    case INTERNET_STATUS_CLOSING_CONNECTION:
        {
#ifdef _DEBUG
            WriteLog(_T("StatusCallback ClosingConnection: info 0x%p size: %u, context: 0x%p"), lpvStatusInformation, dwStatusInformationLength, dwContext);
#endif
        }
        break;
    case INTERNET_STATUS_CONNECTED_TO_SERVER:
        {
#ifdef _DEBUG
            WriteLog(_T("StatusCallback ConnectedToServer: info 0x%p size: %u, context: 0x%p"), lpvStatusInformation, dwStatusInformationLength, dwContext);
#endif
        }
        break;
    case INTERNET_STATUS_CONNECTING_TO_SERVER:
        {
#ifdef _DEBUG
            WriteLog(_T("StatusCallback ConnectingToServer: info 0x%p size: %u, context: 0x%p"), lpvStatusInformation, dwStatusInformationLength, dwContext);
#endif
        }
        break;
    case INTERNET_STATUS_CONNECTION_CLOSED:
        {
#ifdef _DEBUG
            WriteLog(_T("StatusCallback ConnectionClosed: info 0x%p size: %u, context: 0x%p"), lpvStatusInformation, dwStatusInformationLength, dwContext);
#endif
        }
        break;
    case INTERNET_STATUS_HANDLE_CLOSING:
        {
#ifdef _DEBUG
            WriteLog(_T("StatusCallback HandleClosing: info 0x%p size: %u, context: 0x%p"), lpvStatusInformation, dwStatusInformationLength, dwContext);
#endif
    ...
    case INTERNET_STATUS_HANDLE_CREATED:
        {
#ifdef _DEBUG
            WriteLog(_T("StatusCallback HandleCreated: info 0x%p size: %u, context: 0x%p"), lpvStatusInformation, dwStatusInformationLength, dwContext);
#endif
#if 0
    ...
    case INTERNET_STATUS_INTERMEDIATE_RESPONSE:
        {
#ifdef _DEBUG
            WriteLog(_T("StatusCallback IntermediateResponse: info 0x%p size: %u, context: 0x%p"), lpvStatusInformation, dwStatusInformationLength, dwContext);
#endif
        }
        break;
    case INTERNET_STATUS_RECEIVING_RESPONSE:
        {
#ifdef _DEBUG
            WriteLog(_T("StatusCallback ReceivingResponse: info 0x%p size: %u, context: 0x%p"), lpvStatusInformation, dwStatusInformationLength, dwContext);
#endif
        }
        break;
    case INTERNET_STATUS_RESPONSE_RECEIVED:
        {
#ifdef _DEBUG
            WriteLog(_T("StatusCallback ResponseReceived: info 0x%p size: %u, context: 0x%p"), lpvStatusInformation, dwStatusInformationLength, dwContext);
#endif
    ...
    case INTERNET_STATUS_REDIRECT:
        {
#ifdef _DEBUG
            WriteLog(_T("StatusCallback Redirect: info 0x%p size: %u, context: 0x%p"), lpvStatusInformation, dwStatusInformationLength, dwContext);
#endif
        }
        break;
    case INTERNET_STATUS_REQUEST_COMPLETE:
        {
#ifdef _DEBUG
            WriteLog(_T("StatusCallback RequestComplete: info 0x%p size: %u, context: 0x%p"), lpvStatusInformation, dwStatusInformationLength, dwContext);
#endif
    ...
    case INTERNET_STATUS_REQUEST_SENT:
        {
#ifdef _DEBUG
            WriteLog(_T("StatusCallback RequestSent: info 0x%p size: %u, context: 0x%p"), lpvStatusInformation, dwStatusInformationLength, dwContext);
#endif
        }
        break;
    case INTERNET_STATUS_DETECTING_PROXY:
        {
#ifdef _DEBUG
            WriteLog(_T("StatusCallback DetectingProxy: info 0x%p size: %u, context: 0x%p"), lpvStatusInformation, dwStatusInformationLength, dwContext);
#endif
        }
        break;
    case INTERNET_STATUS_RESOLVING_NAME:
        {
#ifdef _DEBUG
            WriteLog(_T("StatusCallback ResolvingName: info 0x%p size: %u, context: 0x%p"), lpvStatusInformation, dwStatusInformationLength, dwContext);
#endif
        }
        break;
    case INTERNET_STATUS_NAME_RESOLVED:
        {
#ifdef _DEBUG
            WriteLog(_T("StatusCallback NameResolved: info 0x%p size: %u, context: 0x%p"), lpvStatusInformation, dwStatusInformationLength, dwContext);
#endif
        }
        break;
    case INTERNET_STATUS_SENDING_REQUEST:
        {
#ifdef _DEBUG
            WriteLog(_T("StatusCallback SendingRequest: info 0x%p size: %u, context: 0x%p"), lpvStatusInformation, dwStatusInformationLength, dwContext);
#endif
        }
        break;
    case INTERNET_STATUS_STATE_CHANGE:
        {
#ifdef _DEBUG
            WriteLog(_T("StatusCallback StateChange: info 0x%p size: %u, context: 0x%p"), lpvStatusInformation, dwStatusInformationLength, dwContext);
#endif
        }
        break;
    case INTERNET_STATUS_P3P_HEADER:
        {
#ifdef _DEBUG
            WriteLog(_T("StatusCallback P3pHeader: info 0x%p size: %u, context: 0x%p"), lpvStatusInformation, dwStatusInformationLength, dwContext);
#endif
        }
        break;
    }
...
IDownloader* CreateDownloader() { return new InternetDownloader(); }

InternetDownloader::InternetDownloader() {}

InternetDownloader::~InternetDownloader() { DeInit(); }
...
bool InternetDownloader::Init(const std::string& InHostPath)
{
	...
	hInternet = InternetOpen(
		...
		INTERNET_FLAG_ASYNC);
#else
    hInternet = InternetOpen(_T("Turtle Patcher"), INTERNET_OPEN_TYPE_PRECONFIG, NULL, NULL, 0);
#endif
...
bool InternetDownloader::DownloadAsync()
{
    ...
    hConnection = InternetOpenUrlA(hInternet, HostPath.c_str(), nullptr, 0, Flags, (DWORD_PTR)this);
...
void InternetDownloader::ProcessAsyncResult(DWORD_PTR dwResult, DWORD ErrCode)
{
    ...
    auto ThreadProcEntryPointLambda = [this]() { DownloadThreadProc(); };
