#ifndef _PEUTILS_HPP_
#define _PEUTILS_HPP_
...
public:
    ...
    public:
        ...
        inline const IMAGE_SECTION_HEADER& ImageSectionHeader() const { return m_imageSectionHeader; }
...
public:
    ...
    VOID AddSection(LPSTR, DWORD, DWORD, DWORD);
