...
#define MPQ_FILE_SECTOR_CRC                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           \
    0x04000000 // File has checksums for each sector.
...
#define MPQ_FILE_VALID_FLAGS (MPQ_FILE_IMPLODE | MPQ_FILE_COMPRESS | MPQ_FILE_ENCRYPTED | MPQ_FILE_FIX_KEY | MPQ_FILE_PATCH_FILE | MPQ_FILE_SINGLE_UNIT | MPQ_FILE_DELETE_MARKER | MPQ_FILE_SECTOR_CRC | MPQ_FILE_SIGNATURE | MPQ_FILE_EXISTS)

#define MPQ_FILE_VALID_FLAGS_W3X (MPQ_FILE_IMPLODE | MPQ_FILE_COMPRESS | MPQ_FILE_ENCRYPTED | MPQ_FILE_FIX_KEY | MPQ_FILE_DELETE_MARKER | MPQ_FILE_SECTOR_CRC | MPQ_FILE_SIGNATURE | MPQ_FILE_EXISTS)
