...
namespace tga
{
    ...
    bool StdioFileInterface::ok() const { return m_ok; }

    size_t StdioFileInterface::tell() { return ftell(m_file); }
    ...
    void StdioFileInterface::write8(uint8_t value) { fputc(value, m_file); }
