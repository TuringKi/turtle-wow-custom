...
public:
    ...
    ICF SelfRef set(const T _x, const T _y, const T _z) noexcept
    {
        x = _x;
        y = _y;
        z = _z;
    ...
    ICF SelfRef set(SelfCRef v) noexcept
    {
        x = T(v.x);
        y = T(v.y);
        z = T(v.z);
    ...
    ICF SelfRef set(const T* p) noexcept
    {
        x = p[0];
        y = p[1];
        z = p[2];
    ...
    ICF SelfRef add(SelfCRef v) noexcept
    {
        x += v.x;
        y += v.y;
        z += v.z;
    ...
    ICF SelfRef add(const T s) noexcept
    {
        x += s;
        y += s;
        z += s;
    ...
    ICF SelfRef add(SelfCRef a, SelfCRef v) noexcept
    {
        x = a.x + v.x;
        y = a.y + v.y;
        z = a.z + v.z;
    ...
    ICF SelfRef add(SelfCRef a, const T s) noexcept
    {
        x = a.x + s;
        y = a.y + s;
        z = a.z + s;
    ...
    ICF SelfRef sub(SelfCRef v) noexcept
    {
        x -= v.x;
        y -= v.y;
        z -= v.z;
    ...
    ICF SelfRef sub(const T s) noexcept
    {
        x -= s;
        y -= s;
        z -= s;
    ...
    ICF SelfRef sub(SelfCRef a, SelfCRef v) noexcept
    {
        x = a.x - v.x;
        y = a.y - v.y;
        z = a.z - v.z;
    ...
    ICF SelfRef sub(SelfCRef a, const T s) noexcept
    {
        x = a.x - s;
        y = a.y - s;
        z = a.z - s;
    ...
    ICF SelfRef mul(SelfCRef v) noexcept
    {
        x *= v.x;
        y *= v.y;
        z *= v.z;
    ...
    ICF SelfRef mul(const T s) noexcept
    {
        x *= s;
        y *= s;
        z *= s;
    ...
    ICF SelfRef mul(SelfCRef a, SelfCRef v) noexcept
    {
        x = a.x * v.x;
        y = a.y * v.y;
        z = a.z * v.z;
    ...
    ICF SelfRef mul(SelfCRef a, const T s) noexcept
    {
        x = a.x * s;
        y = a.y * s;
        z = a.z * s;
    ...
    ICF SelfRef div(SelfCRef v) noexcept
    {
        x /= v.x;
        y /= v.y;
        z /= v.z;
    ...
    ICF SelfRef div(const T s) noexcept
    {
        x /= s;
        y /= s;
        z /= s;
    ...
    ICF SelfRef div(SelfCRef a, SelfCRef v) noexcept
    {
        x = a.x / v.x;
        y = a.y / v.y;
        z = a.z / v.z;
    ...
    ICF SelfRef div(SelfCRef a, const T s) noexcept
    {
        x = a.x / s;
        y = a.y / s;
        z = a.z / s;
    ...
    IC SelfRef abs(SelfCRef v) noexcept
    {
        x = _abs(v.x);
        y = _abs(v.y);
        z = _abs(v.z);
    ...
    // SQ magnitude
    IC T square_magnitude() const { return x * x + y * y + z * z; }
    // magnitude
    ...
    // DotProduct
    ICF T dotproduct(SelfCRef v) const { return x * v.x + y * v.y + z * v.z; }
    ...
    IC SelfRef reflect(SelfCRef dir, SelfCRef norm) { return mad(dir, norm, -2 * dir.dotproduct(norm)); }
