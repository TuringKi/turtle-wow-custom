...
public:
    ...
    inline int getMemUsed() const { return sizeof(*this) + sizeof(dtNode) * m_maxNodes + sizeof(dtNodeIndex) * m_maxNodes + sizeof(dtNodeIndex) * m_hashSize; }
...
public:
    ...
    inline int getMemUsed() const { return sizeof(*this) + sizeof(dtNode*) * (m_capacity + 1); }
