...
namespace re2
{
    ...
    public:
        ...
        void set_option(PCRE::Option option) { option_ = option; }
        int match_limit() const { return match_limit_; }
        void set_match_limit(int match_limit) { match_limit_ = match_limit; }
        int stack_limit() const { return stack_limit_; }
        void set_stack_limit(int stack_limit) { stack_limit_ = stack_limit; }
        ...
        void set_report_errors(bool report_errors) { report_errors_ = report_errors; }
...
#undef MAKE_PARSER
        ...
        template <typename T>
        Arg(T* p) : arg_(p), parser_(_PCRE_MatchObject<T>::Parse)
        {
        }
...
private:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
    ...
    static bool parse_##name##_radix(const char* str, size_t n, void* dest, int radix);                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               \
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      \
public:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               \
...
#undef DECLARE_INTEGER_PARSER
    ...
    inline bool PCRE::Arg::Parse(const char* str, size_t n) const { return (*parser_)(str, n, arg_); }

// This part of the parser, appropriate only for ints, deals with bases
#define MAKE_INTEGER_PARSER(type, name)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               \
    inline PCRE::Arg Hex(type* ptr) { return PCRE::Arg(ptr, PCRE::Arg::parse_##name##_hex); }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         \
    inline PCRE::Arg Octal(type* ptr) { return PCRE::Arg(ptr, PCRE::Arg::parse_##name##_octal); }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     \
    inline PCRE::Arg CRadix(type* ptr) { return PCRE::Arg(ptr, PCRE::Arg::parse_##name##_cradix); }
