...
namespace dpp
{
    ...
    scheduled_event::scheduled_event() : managed(0), guild_id(0), channel_id(0), creator_id(0), scheduled_start_time(0), scheduled_end_time(0), privacy_level(ep_guild_only), status(es_scheduled), entity_type(eet_external), entity_id(0), user_count(0) {}
