...
namespace dpp
{
    ...
    void https_client::connect()
    {
        ...
        {
            this->write(this->request_type + " " + this->path +
                        " HTTP/1.1\r\n"
                        "Host: " +
                        this->hostname +
                        "\r\n"
    ...
    const std::map<std::string, std::string> https_client::get_headers() const { return response_headers; }
    ...
    uint16_t https_client::get_status() const { return status; }

    const std::string https_client::get_content() const { return body; }

    http_state https_client::get_state() { return this->state; }
