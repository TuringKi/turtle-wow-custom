...
namespace dpp
{
    ...
    bool emoji::requires_colons() const { return flags & e_require_colons; }

    bool emoji::is_managed() const { return flags & e_managed; }

    bool emoji::is_animated() const { return flags & e_animated; }

    bool emoji::is_available() const { return flags & e_available; }
    ...
    std::string emoji::format() const { return id ? ((is_animated() ? "a:" : "") + name + ":" + std::to_string(id)) : name; }
