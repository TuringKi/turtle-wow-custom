...
namespace dpp
{
    ...
    public:
        ...
        collector(class cluster* cl, uint64_t duration, event_router_t<T>& event) : owner(cl), triggered(false)
        {
            ...
            tl = new dpp::timed_listener<event_router_t<T>, std::function<void(const T&)>>(cl, duration, event, f,
    ...
    public:
        ...
        ~collected_reaction() noexcept = default;
    };
