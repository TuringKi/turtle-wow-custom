...
namespace dpp
{
    ...
    public:
         ...
         */
        T& fill_from_json(nlohmann::json* j) { throw dpp::logic_exception("JSON interface doesn't implement parse_from_json"); }
         ...
         */
        virtual std::string build_json(bool with_id = false) const { throw dpp::logic_exception("JSON interface doesn't implement build_json"); }
    };
}; // namespace dpp
