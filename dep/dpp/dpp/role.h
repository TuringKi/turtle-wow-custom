...
namespace dpp
{
    ...
    public:
         ...
         */
        friend inline bool operator<(const role& lhs, const role& rhs) { return lhs.position < rhs.position; }
         ...
         */
        inline bool operator==(const role& other) const { return this->position == other.position; }
