...
namespace dpp
{
    ...
    public:
         ...
         */
        cache() { cache_map = new std::unordered_map<snowflake, T*>; }
         ...
         */
        std::shared_mutex& get_mutex() { return this->cache_mutex; }
         ...
         */
        auto& get_container() { return *(this->cache_map); }
...
#define cache_decl(type, setter, getter, counter)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     \
    DPP_EXPORT class type* setter(snowflake id);                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      \
    DPP_EXPORT cache<class type>* getter();                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           \
    DPP_EXPORT uint64_t counter();
