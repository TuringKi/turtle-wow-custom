...
#define EVP_PKEY_CTX_set1_scrypt_salt(pctx, salt, saltlen) EVP_PKEY_CTX_ctrl(pctx, -1, EVP_PKEY_OP_DERIVE, EVP_PKEY_CTRL_SCRYPT_SALT, saltlen, (void*)(salt))
...
#define EVP_PKEY_CTX_set_scrypt_maxmem_bytes(pctx, maxmem_bytes) EVP_PKEY_CTX_ctrl_uint64(pctx, -1, EVP_PKEY_OP_DERIVE, EVP_PKEY_CTRL_SCRYPT_MAXMEM_BYTES, maxmem_bytes)
