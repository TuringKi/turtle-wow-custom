...
extern void bchange(uchar* dst, size_t old_len, const uchar* src, size_t new_len, size_t tot_len);
...
extern char* str2int(const char* src, int radix, long lower, long upper, long* val);
...
static inline const uchar* skip_trailing_space(const uchar* ptr, size_t len)
{
    ...
    if (len > 20)
    {
        const uchar* end_words = (const uchar*)(intptr)(((ulonglong)(intptr)end) / SIZEOF_INT * SIZEOF_INT);
        const uchar* start_words = (const uchar*)(intptr)((((ulonglong)(intptr)ptr) + SIZEOF_INT - 1) / SIZEOF_INT * SIZEOF_INT);
