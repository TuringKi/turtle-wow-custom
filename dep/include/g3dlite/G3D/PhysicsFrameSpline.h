...
namespace G3D
{
    ...
    public:
        ...
        bool operator!=(const PhysicsFrameSpline& a) const { return !((*this) == a); }
        ...
        virtual Any toAny(const std::string& myName) const override { return Spline<PhysicsFrame>::toAny(myName); }
