...
namespace G3D
{
    ...
    public:
        ...
        /** vertex[1] - vertex[0] */
        inline const Vector3& edge01() const { return _edge01; }

        /** vertex[2] - vertex[0] */
        inline const Vector3& edge02() const { return _edge02; }

        float area() const;

        Vector3::Axis primaryAxis() const { return _primaryAxis; }
        ...
        inline void getRandomSurfacePoint(Point3& P, Vector3& N = Vector3::ignore()) const
        {
            P = randomPoint();
            N = normal();
        }
        ...
        inline size_t hashCode() const { return _vertex[0].hashCode() + (_vertex[1].hashCode() >> 2) + (_vertex[2].hashCode() >> 3); }
