...
namespace G3D
{
    ...
    public:
        ...
        inline bool isZero() const { return (r == 0.0f) && (g == 0.0f) && (b == 0.0f) && (a == 0.0f); }

        inline bool isOne() const { return (r == 1.0f) && (g == 1.0f) && (b == 1.0f) && (a == 1.0f); }
        ...
        Color4 operator*(const Color4& k) const { return Color4(r * k.r, g * k.g, b * k.b, a * k.a); }
        ...
        inline Color4 max(const Color4& other) const { return Color4(G3D::max(r, other.r), G3D::max(g, other.g), G3D::max(b, other.b), G3D::max(a, other.a)); }

        inline Color4 min(const Color4& other) const { return Color4(G3D::min(r, other.r), G3D::min(g, other.g), G3D::min(b, other.b), G3D::min(a, other.a)); }

        /** r + g + b + a */
        inline float sum() const { return r + g + b + a; }

        inline Color4 lerp(const Color4& other, float a) const { return (*this) + (other - *this) * a; }
        ...
        inline bool isFinite() const { return G3D::isFinite(r) && G3D::isFinite(g) && G3D::isFinite(b) && G3D::isFinite(a); }
    ...
    inline Color4 operator*(const Color3& c3, const Color4& c4) { return Color4(c3.r * c4.r, c3.g * c4.g, c3.b * c4.b, c4.a); }
    ...
    inline Color4::Color4(float r, float g, float b, float a) : r(r), g(g), b(b), a(a) {}
    ...
    inline bool Color4::operator==(const Color4& other) const { return (r == other.r && g == other.g && b == other.b && a == other.a); }
    ...
    //----------------------------------------------------------------------------
    inline Color4 Color4::operator+(const Color4& other) const { return Color4(r + other.r, g + other.g, b + other.b, a + other.a); }
    ...
    inline Color4 Color4::operator*(float fScalar) const { return Color4(fScalar * r, fScalar * g, fScalar * b, fScalar * a); }
    ...
    inline Color4 operator*(float fScalar, const Color4& other) { return Color4(fScalar * other.r, fScalar * other.g, fScalar * other.b, fScalar * other.a); }
