...
namespace G3D
{
    ...
    public:
         ...
         */
        inline const uint8* getCArray() const { return m_buffer; }
        ...
        */
        ...
        inline int64 length() const { return m_bufferLen + m_alreadyWritten; }

        inline int64 size() const { return length(); }
         ...
         */
        inline int64 position() const { return m_pos + m_alreadyWritten; }
        ...
        inline void writeBool8(bool b) { writeInt8(b ? 1 : 0); }
        ...
        inline void writeUNorm8(unorm8 i) { writeUInt8(i.bits()); }

        void writeUInt16(uint16 u);

        inline void writeInt16(int16 i) { writeUInt16(*(uint16*)&i); }
        ...
        inline void writeInt64(int64 i) { writeUInt64(*(uint64*)&i); }
         ...
         */
        inline void writeString(const std::string& s) { writeString(s.c_str()); }
         ...
         */
        void writeStringEven(const std::string& s) { writeStringEven(s.c_str()); }
         ...
         */
        void writeString32(const std::string& s) { writeString32(s.c_str()); }
