...
namespace G3D
{
    ...
    public:
      ...
      z/
        ...
        inline Vector3 extent() const { return Vector3(_edgeVector[0].length(), _edgeVector[1].length(), _edgeVector[2].length()); }
    ...
    z/
        ...
        bool isFinite() const { return G3D::isFinite(_volume); }
    };
