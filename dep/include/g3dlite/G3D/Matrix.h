...
namespace G3D
{
    ...
    public:
        ...
        private:
            ...
            inline Impl(int r, int c) : elt(NULL), data(NULL), R(0), C(0), dataSize(0) { setSize(r, c); }
    ...
    private:
        ...
        public:
            ...
            inline bool operator>(const SortRank& x) const { return x.value > value; }
...
inline G3D::Matrix operator-(const G3D::Matrix::T& v, const G3D::Matrix& M) { return M.lsub(v); }

inline G3D::Matrix operator*(const G3D::Matrix::T& v, const G3D::Matrix& M) { return M * v; }
