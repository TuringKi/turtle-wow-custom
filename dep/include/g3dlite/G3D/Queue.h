...
#define FIND_ENDS                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     \
    ...
    private:
        ...
        /**
         ...
         may be negative.
         */
        inline int index(int i) const { return (head + i + numAllocated) % numAllocated; }
    ...
    public:
        Queue() : data(NULL), head(0), num(0), numAllocated(0) {}


        /**
        Copy constructor
        */
        Queue(const Queue& other) : data(NULL) { _copy(other); }
        ...
        */
        ...
        /**
         pushBack
         */
        inline void enqueue(const T& e) { pushBack(e); }
        ...
        /**
         popFront
         */
        inline T dequeue() { return popFront(); }
