    ...
    public:
        ...
        /**
          ...
          @param v2         Triangle vertex 3
           ...
           @return Time til collision.  If there is no collision then the return
                   value will be inf().
         */
        inline static float collisionTimeForMovingPointFixedTriangle(const Vector3& orig, const Vector3& dir, const Vector3& v0, const Vector3& v1, const Vector3& v2) { return Ray::fromOriginAndDirection(orig, dir).intersectionTime(v0, v1, v2); }
        ...
        /**
          ...
          @param v2         Triangle vertex 3
           ...
           @return Time til collision.  If there is no collision then the return
                   value will be inf().
         */
        inline static float collisionTimeForMovingPointFixedTriangle(const Vector3& orig, const Vector3& dir, const Vector3& v0, const Vector3& v1, const Vector3& v2, Vector3& location)
        {
        ...
        /**
           ...
           @return Time til collision.  If there is no collision then the return
                   value will be inf().
         */
        inline static float collisionTimeForMovingPointFixedTriangle(const Vector3& orig, const Vector3& dir, const Triangle& tri, Vector3& location = ignore, Vector3& normal = ignore)
        {
        ...
        /**
          ...
          @param v2         Triangle vertex 3
           ...
           @return Time til collision.  If there is no collision then the return
                   value will be inf().
         */
        inline static float collisionTimeForMovingPointFixedTriangle(const Vector3& orig, const Vector3& dir, const Vector3& v0, const Vector3& v1, const Vector3& v2, Vector3& location, Vector3& normal)
        {
            float t = collisionTimeForMovingPointFixedTriangle(orig, dir, v0, v1, v2);
            if (t < finf())
            {
        ...
        */
        ...
        inline static bool isPointInsideTriangle(const Vector3& v0, const Vector3& v1, const Vector3& v2, const Vector3& normal, const Vector3& point, Vector3::Axis primaryAxis = Vector3::DETECT_AXIS)
        {
