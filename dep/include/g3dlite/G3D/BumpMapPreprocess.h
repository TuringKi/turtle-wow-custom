...
namespace G3D
{
    ...
    */
    ...
    public:
        ...
        bool operator==(const BumpMapPreprocess& other) const { return (lowPassFilter == other.lowPassFilter) && (zExtentPixels == other.zExtentPixels) && (scaleZByNz == other.scaleZByNz); }
    };
