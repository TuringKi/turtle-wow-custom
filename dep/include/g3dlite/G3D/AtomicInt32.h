...
namespace G3D
{
    ...
    public:
        ...
        /** Atomic set */
        explicit AtomicInt32(const int32 x) { m_value = x; }

        /** Atomic set */
        AtomicInt32(const AtomicInt32& x) { m_value = x.m_value; }
        ...
        /** Atomic set */
        void operator=(const AtomicInt32& x) { m_value = x.m_value; }
...
#pragma error "FATAL ERROR: unsupported compiler."
        ...
        /** Returns old value. */
        int32 sub(const int32 x) { return add(-x); }
