...
namespace G3D
{
    ...
    public:
        Token() : _string(""), _bool(false), _line(0), _character(0), _bytePosition(0), _type(END), _extendedType(END_TYPE) {}

        Token(Type t, ExtendedType e, const std::string& s, int L, int c, uint64 byte) : _string(s), _bool(false), _line(L), _character(c), _bytePosition(byte), _type(t), _extendedType(e) {}

        Token(Type t, ExtendedType e, const std::string& s, bool b, int L, int c, uint64 byte) : _string(s), _bool(b), _line(L), _character(c), _bytePosition(byte), _type(t), _extendedType(e) {}

        Type type() const { return _type; }

        ExtendedType extendedType() const { return _extendedType; }
        ...
        /** Number of bytes from the beginning of the buffer that this token was parsed from.
          Begins at 0 */
        uint64 bytePosition() const { return _bytePosition; }
    ...
    public:
        ...
        */
        ...
        void popSettings() { options = settingsStack.pop(); }
