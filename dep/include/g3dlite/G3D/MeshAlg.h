...
namespace G3D
{
    ...
    public:
        ...
        public:
             ...
             */
            inline bool inEdge(int e) const { return edgeIndex.contains(~e) || edgeIndex.contains(e); }
        ...
        public:
            ...
            inline bool containsVertex(int v) const { return contains(vertexIndex, 3, v); }
            ...
            /** Contains the forward edge e if e >= 0 and the backward edge
                ~e otherwise. */
            inline bool containsDirectedEdge(int e) const { return contains(edgeIndex, 3, e); }
        };
        ...
        public:
            ...
            inline bool containsVertex(int v) const { return contains(vertexIndex, 2, v); }
            ...
            inline bool inFace(int f) const { return contains(faceIndex, 2, f); }

            /**
             Returns true if either faceIndex is NONE.
             */
            inline bool boundary() const { return (faceIndex[0] == Face::NONE) || (faceIndex[1] == Face::NONE); }
    ...
    public:
        ...
        */
        ...
        static void toIndexedTriList(const Array<IndexType>& inIndices, MeshAlg::Primitive inType, Array<IndexType>& outIndices)
        {
            ...
            debugAssert(inType == PrimitiveType::TRIANGLE_STRIP || inType == PrimitiveType::TRIANGLE_FAN || inType == PrimitiveType::QUADS || inType == PrimitiveType::QUAD_STRIP);
