...
namespace G3D
{
    ...
    */
    ...
    public:
        ...
        bool uninitialized() const { return id == 0; }

        uint16 tag() const { return id >> 54; }

        operator uint64() const { return id; }

        bool operator==(const GUniqueID& other) const { return id == other.id; }
...
/** For Table and Set */
template <>
struct HashTrait<class G3D::GUniqueID>
{
