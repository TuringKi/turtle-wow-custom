...
namespace G3D
{
    ...
    public:
        ...
        /** Amount of time between the most recent tick and tock calls.  0 if tick has
            never been called. */
        RealTime elapsedTime() const { return lastDuration; }
        ...
        RealTime smoothElapsedTime() const { return emwaDuration; }
        ...
        double smoothFPS() const { return m_smoothFPS; }
        ...
        uint64 elapsedCycles() const { return lastCycleCount; }
