...
namespace G3D
{
    ...
    public:
        ...
        */
        ...
        Sphere operator+(const Vector3& v) const { return Sphere(center + v, radius); }
...
{
    static size_t hashCode(const G3D::Sphere& key) { return static_cast<size_t>(key.center.hashCode() + (key.radius * 13)); }
};
