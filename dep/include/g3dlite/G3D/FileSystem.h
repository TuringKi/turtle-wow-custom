    ...
    */
    ...
    public:
        ...
        public:
            ...
            ListSettings() :
                ...
                caseSensitive(false),
#endif
                recursive(false), includeParentPath(true)
            {
            }
        };
    ...
    private:
        ...
        public:
            ...
            bool contains(const std::string& child,
                          bool caseSensitive =
#ifdef G3D_WINDOWS
                              false
#else
        ...
        float _cacheLifetime() const { return m_cacheLifetime; }
        ...
        /** \copydoc isFile */
        bool _isFile(const std::string& path) { return !isDirectory(path); }
