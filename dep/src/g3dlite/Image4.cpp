...
namespace G3D
{
    ...
    Image4::Ref Image4::createEmpty(int width, int height, WrapMode wrap) { return shared_ptr<Image4>(new Type(width, height, wrap)); }


    Image4::Ref Image4::createEmpty(WrapMode wrap) { return createEmpty(0, 0, wrap); }
    ...
    const ImageFormat* Image4::format() const { return ImageFormat::RGBA32F(); }
