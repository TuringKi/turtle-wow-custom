...
namespace G3D
{
    Vector3int32 iFloor(const Vector3& v) { return Vector3int32(iFloor(v.x), iFloor(v.y), iFloor(v.z)); }
    ...
    Vector3int32 Vector3int32::truncate(const class Vector3& v) { return Vector3int32(int32(v.x), int32(v.y), int32(v.z)); }
    ...
    Vector3int32::Vector3int32(class BinaryInput& bi) { deserialize(bi); }
