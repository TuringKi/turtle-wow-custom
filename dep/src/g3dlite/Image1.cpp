...
namespace G3D
{
    ...
    Image1::Ref Image1::createEmpty(int width, int height, WrapMode wrap) { return Image1::Ref(new Type(width, height, wrap)); }


    Image1::Ref Image1::createEmpty(WrapMode wrap) { return createEmpty(0, 0, wrap); }
    ...
    const ImageFormat* Image1::format() const { return ImageFormat::L32F(); }
