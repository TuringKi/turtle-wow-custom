...
#pragma warning(disable : 4530)
    ...
    int stringCompare(const std::string& s1, const std::string& s2) { return stringPtrCompare(&s1, &s2); }


    int stringPtrCompare(const std::string* s1, const std::string* s2) { return s1->compare(*s2); }
