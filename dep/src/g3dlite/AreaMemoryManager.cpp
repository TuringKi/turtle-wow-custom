...
namespace G3D
{
    ...
    AreaMemoryManager::Buffer::~Buffer() { ::free(m_first); }
    ...
    bool AreaMemoryManager::isThreadsafe() const { return false; }


    AreaMemoryManager::Ref AreaMemoryManager::create(size_t sizeHint) { return shared_ptr<AreaMemoryManager>(new AreaMemoryManager(sizeHint)); }


    AreaMemoryManager::AreaMemoryManager(size_t sizeHint) : m_sizeHint(sizeHint) { debugAssert(sizeHint > 0); }


    AreaMemoryManager::~AreaMemoryManager() { deallocateAll(); }


    size_t AreaMemoryManager::bytesAllocated() const { return m_sizeHint * m_bufferArray.size(); }
