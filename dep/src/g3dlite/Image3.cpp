...
namespace G3D
{
    ...
    Image3::Ref Image3::createEmpty(int width, int height, WrapMode wrap) { return shared_ptr<Image3>(new Image3(width, height, wrap)); }


    Image3::Ref Image3::createEmpty(WrapMode wrap) { return createEmpty(0, 0, wrap); }
    ...
    const ImageFormat* Image3::format() const { return ImageFormat::RGB32F(); }
