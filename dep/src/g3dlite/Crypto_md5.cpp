...
namespace G3D
{
    ...
    MD5Hash::MD5Hash(class BinaryInput& b) { deserialize(b); }


    void MD5Hash::deserialize(class BinaryInput& b) { b.readBytes(value, 16); }


    void MD5Hash::serialize(class BinaryOutput& b) const { b.writeBytes(value, 16); }
