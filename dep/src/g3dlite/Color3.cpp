...
namespace G3D
{
    ...
    {
        static const Color3 map[] = {Color3::black(), Color3::red() * 0.75f, Color3::green() * 0.75f, Color3::yellow() * 0.75f, Color3::blue() * 0.75f, Color3::purple() * 0.75f, Color3::cyan() * 0.75f, Color3::white() * 0.75f, Color3::white() * 0.90f, Color3::red(), Color3::green(), Color3::yellow(), Color3::blue(), Color3::purple(), Color3::cyan(), Color3::white()};
    ...
    bool Color3::isFinite() const { return G3D::isFinite(r) && G3D::isFinite(g) && G3D::isFinite(b); }
    ...
    {
        static const Color3 colorArray[8] = {Color3::blue(), Color3::red(), Color3::green(), Color3::orange(), Color3::yellow(), Color3::cyan(), Color3::purple(), Color3::brown()};
    ...
    Color3 Color3::fromARGB(uint32 x) { return Color3(Color3unorm8::fromARGB(x)); }

    Color3 Color3::fromASRGB(uint32 x) { return Color3(Color3unorm8::fromARGB(x)).pow(2.2f); }
    ...
    {
        debugAssertM((_hsv.x <= 1.0f && _hsv.x >= 0.0f) && (_hsv.y <= 1.0f && _hsv.y >= 0.0f) && (_hsv.z <= 1.0f && _hsv.z >= 0.0f), "H,S,V must be between [0,1]");
    ...
    {
        debugAssertM((_rgb.r <= 1.0f && _rgb.r >= 0.0f) && (_rgb.g <= 1.0f && _rgb.g >= 0.0f) && (_rgb.b <= 1.0f && _rgb.b >= 0.0f), "R,G,B must be between [0,1]");
    ...
    std::string Color3::toString() const { return G3D::format("(%g, %g, %g)", r, g, b); }
