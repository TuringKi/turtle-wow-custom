...
namespace G3D
{
    ...
    Capsule::Capsule(class BinaryInput& b) { deserialize(b); }


    Capsule::Capsule() {}


    Capsule::Capsule(const Vector3& _p1, const Vector3& _p2, float _r) : p1(_p1), p2(_p2), _radius(_r) {}
    ...
    Line Capsule::axis() const { return Line::fromTwoPoints(p1, p2); }
    ...
    bool Capsule::contains(const Vector3& p) const { return LineSegment::fromTwoPoints(p1, p2).distanceSquared(p) <= square(radius()); }
