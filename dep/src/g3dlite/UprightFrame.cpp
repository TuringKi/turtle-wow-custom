...
namespace G3D
{
    ...
    UprightFrame UprightFrame::operator+(const UprightFrame& other) const { return UprightFrame(translation + other.translation, pitch + other.pitch, yaw + other.yaw); }


    UprightFrame UprightFrame::operator*(const float k) const { return UprightFrame(translation * k, pitch * k, yaw * k); }
    ...
    Any UprightSpline::toAny() const { return toAny("UprightSpline"); }
