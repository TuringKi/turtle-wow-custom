...
namespace G3D
{
    ...
    size_t Vector4::hashCode() const { return HashTrait<uint128>::hashCode(*((uint128*)this)); }
    ...
    std::string Vector4::toString() const { return G3D::format("(%g, %g, %g, %g)", x, y, z, w); }
    // 2-char swizzles
    ...
    void serialize(const Vector4& v, class BinaryOutput& b) { v.serialize(b); }

    void deserialize(Vector4& v, class BinaryInput& b) { v.deserialize(b); }
