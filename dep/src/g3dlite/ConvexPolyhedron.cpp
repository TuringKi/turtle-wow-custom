...
namespace G3D
{
    ...
    ConvexPolygon::ConvexPolygon(const Vector3& v0, const Vector3& v1, const Vector3& v2) { _vertex.append(v0, v1, v2); }


    bool ConvexPolygon::isEmpty() const { return (_vertex.length() == 0) || (getArea() <= fuzzyEpsilon32); }
    ...
    bool ConvexPolyhedron::isEmpty() const { return (face.length() == 0) || (getVolume() <= fuzzyEpsilon32); }
