...
namespace G3D
{
    ...
    const Color4& Color4::clear() { return Color4::zero(); }
    ...
    Color4 Color4::fromARGB(uint32 x) { return Color4((float)((x >> 16) & 0xFF), (float)((x >> 8) & 0xFF), (float)(x & 0xFF), (float)((x >> 24) & 0xFF)) / 255.0; }


    Color4::Color4(BinaryInput& bi) { deserialize(bi); }
    ...
    std::string Color4::toString() const { return G3D::format("(%g, %g, %g, %g)", r, g, b, a); }
