...
namespace G3D
{
    ...
    void BinaryOutput::writeBool8(const Array<bool>& out, int n) { writeBool8(out.getCArray(), n); }

#define IMPLEMENT_WRITER(ucase, lcase)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                \
    void BinaryOutput::write##ucase(const std::vector<lcase>& out, int n) { write##ucase(&out[0], n); }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               \
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      \
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      \
    void BinaryOutput::write##ucase(const Array<lcase>& out, int n) { write##ucase(out.getCArray(), n); }
...
#undef IMPLEMENT_WRITER
    ...
    bool BinaryOutput::ok() const { return m_ok; }
    ...
    void BinaryOutput::compress(int level)
    {
        ...
        uLongf compressedSize = iCeil(m_bufferLen * 1.001) + 12;
