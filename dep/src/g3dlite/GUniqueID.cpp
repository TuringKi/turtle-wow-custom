...
namespace G3D
{
    ...
    void GUniqueID::serialize(BinaryOutput& b) const { b.writeUInt64(id); }


    void GUniqueID::deserialize(BinaryInput& b) { id = b.readUInt64(); }
    ...
    std::string GUniqueID::toString16() const { return format("%08x%08x", uint32(id >> 32), uint32(id & 0xFFFFFFFF)); }
