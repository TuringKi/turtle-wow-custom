...
namespace G3D
{
    ...
    Color1::Color1(BinaryInput& bi) { deserialize(bi); }


    Color3 Color1::rgb() const { return Color3(value, value, value); }
    ...
    Color1::Color1(const class Color1unorm8& other) { value = other.value; }
