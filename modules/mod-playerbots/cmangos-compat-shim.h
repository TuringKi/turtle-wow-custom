...
// GuidSet is supplied by the custom core (ObjectGuid.h).
...
// The custom core supplies the actual movement mask in Object.h.
...
#include <chrono>
// TimePoint is supplied by the custom core.
...
inline bool IsPlayerbotNonCombatSpell(SpellEntry const* spellInfo) {
...
// Use the core steady-clock start timestamp (Timer.h).
...
// Returns pointer-style — bot does *GetPlayerbotRandomGenerator() in some sites.
inline std::mt19937* GetPlayerbotRandomGenerator() {
