...
{
    MANGOS_ASSERT(IsRunning() && "Tried to scheduled the abortion of an event twice!");
...
uint64 EventProcessor::CalculateTime(uint64 t_offset) const { return (m_time + t_offset); }