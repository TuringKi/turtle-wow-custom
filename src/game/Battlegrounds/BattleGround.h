...
{
public:
    BattleGroundScore() : KillingBlows(0), Deaths(0), HonorableKills(0), DishonorableKills(0), BonusHonor(0) {}
...
public:
    ...
    void ActivateEventWithoutSpawn(uint8 event1, uint8 event2) { m_ActiveEvents[event1] = event2; }
