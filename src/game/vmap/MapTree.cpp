...
namespace VMAP
{
    ...
    StaticMapTree::StaticMapTree(uint32 mapID, std::string const& basePath) : iMapID(mapID), iIsTiled(false), iTreeValues(nullptr), iNTreeValues(0), iBasePath(basePath)
    {
    ...
    StaticMapTree::~StaticMapTree() { delete[] iTreeValues; }
