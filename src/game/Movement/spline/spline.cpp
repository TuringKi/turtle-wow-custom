...
namespace Movement
{
    ...
    SplineBase::EvaluationMethtod SplineBase::evaluators[] = {
    ...
    SplineBase::EvaluationMethtod SplineBase::derivative_evaluators[] = {
    ...
    SplineBase::SegLenghtMethtod SplineBase::seglengths[] = {
    ...
    SplineBase::InitMethtod SplineBase::initializers[] = {
