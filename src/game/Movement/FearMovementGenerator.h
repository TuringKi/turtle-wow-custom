...
{
public:
    explicit FearMovementGenerator(ObjectGuid fright) : i_initialFleeTime(DEFAULT_INIT_FLEE_TIME), _timeInitDone(false), _pointInitDone(false), _forceWalking(false), _customSpeed(-1.0f), i_frightGuid(fright), i_nextCheckTime(0), _forceUpdate(false) {}
