...
void WardenScanMgr::AddMacScan(const MacScan* scan) { m_scans.push_back(std::shared_ptr<const MacScan>(scan)); }

void WardenScanMgr::AddMacScan(std::shared_ptr<MacScan> scan) { m_scans.push_back(scan); }

void WardenScanMgr::AddWindowsScan(const WindowsScan* scan) { m_scans.push_back(std::shared_ptr<const WindowsScan>(scan)); }

void WardenScanMgr::AddWindowsScan(std::shared_ptr<WindowsScan> scan) { m_scans.push_back(scan); }
