...
static ChatCommand anticheatFingerprintCommandTable[] = {
    {"list", SEC_ADMINISTRATOR, false, &ChatHandler::HandleAnticheatFingerprintListCommand, "", nullptr}, {"history", SEC_DEVELOPER, false, &ChatHandler::HandleAnticheatFingerprintHistoryCommand, "", nullptr}, {"ahistory", SEC_ADMINISTRATOR, false, &ChatHandler::HandleAnticheatFingerprintAHistoryCommand, "", nullptr}, {"autoban", SEC_SIGMACHAD, false, nullptr, "", anticheatFingerprintAutobanCommandTable}, {nullptr, 0, false, nullptr, "", nullptr},
};


static ChatCommand anticheatHwprintCommandTable[] = {{"mark", SEC_ADMINISTRATOR, true, &ChatHandler::HandleAnticheatHwPrintMarkCommand, "", nullptr}, {"list", SEC_DEVELOPER, true, &ChatHandler::HandleAnticheatHwPrintListCommand, "", nullptr}, {"autoban", SEC_ADMINISTRATOR, false, &ChatHandler::HandleAnticheatHwPrintAutobanCommand, "", nullptr}, {nullptr, 0, false, nullptr, "", nullptr}};
