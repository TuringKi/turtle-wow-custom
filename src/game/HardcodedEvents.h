...
const static InvasionDataStruct InvasionData[] = {{EVENT_FIRE, EVENT_BOSS_F, VAR_DELAY_FIRE, VAR_FIRE_KILLS, VAR_FIRE, BOSS_F_GUID}, {EVENT_AIR, EVENT_BOSS_A, VAR_DELAY_AIR, VAR_AIR_KILLS, VAR_AIR, BOSS_A_GUID}, {EVENT_EARTH, EVENT_BOSS_E, VAR_DELAY_EARTH, VAR_EARTH_KILLS, VAR_EARTH, BOSS_E_GUID}, {EVENT_WATER, EVENT_BOSS_W, VAR_DELAY_WATER, VAR_WATER_KILLS, VAR_WATER, BOSS_W_GUID}};
...
static uint32 NightmareDragons[] = {NPC_YSONDRE, NPC_LETHON, NPC_EMERISS, NPC_TAERAR};
...
static const uint16 DMFValidEvent[] = {DARKMOON_A2_INSTALLATION, DARKMOON_A2, DARKMOON_H2_INSTALLATION, DARKMOON_H2};
...
private:
    struct InvasionXYZ
    {
        InvasionXYZ(float x, float y, float z) : x(x), y(y), z(z) {}
        float x, y, z;
    };

    struct InvasionNecropolis
    {
        InvasionNecropolis(float x, float y, float z, float o) : x(x), y(y), z(z), o(o) {}
        float x, y, z, o;
