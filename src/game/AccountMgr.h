...
public:
    ...
    bool IsTraineeGM(uint32 accId) const { return m_traineeGms.find(accId) != m_traineeGms.end(); }
    ...
    bool IsDonator(uint32 accountId) { return m_donatorAccounts.find(accountId) != m_donatorAccounts.end(); }
