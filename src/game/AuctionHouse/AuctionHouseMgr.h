...
struct AuctionEntry
{
    ...
    void AuctionBidWinning(Player* newbidder);
...
public:
    ...
    void BuildListAuctionItems(WorldPacket& data, Player* player, AuctionHouseClientQuery const& query, uint32& count, uint32& totalcount);
