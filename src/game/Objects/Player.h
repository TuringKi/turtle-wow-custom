...
public:
    ...
    PlayerbotAI* GetPlayerbotAI() { return const_cast<PlayerbotAI*>(static_cast<Player const*>(this)->GetPlayerbotAI()); }
    const PlayerbotAI* GetPlayerbotAI() const
    {
#ifdef BUILD_LEGACY_PLAYERBOTS
        return m_playerbotAI;
#else
        return static_cast<PlayerbotAI const*>(GetModuleSlot(MODULE_SLOT_BOT_AI));
#endif
    }
...
public:
    ...
    // Quest-log operations are also used by the upstream bot actions.
