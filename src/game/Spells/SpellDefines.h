...
#define IMMUNE_TO_ROOT_AND_SNARE_MASK ((1 << (MECHANIC_ROOT - 1)) | (1 << (MECHANIC_SNARE - 1)))

#define IMMUNE_TO_ROOT_AND_STUN_MASK ((1 << (MECHANIC_ROOT - 1)) | (1 << (MECHANIC_STUN - 1)))

#define CONFUSED_MECHANIC_MASK ((1 << (MECHANIC_DISORIENTED - 1)) | (1 << (MECHANIC_POLYMORPH - 1)))

// Daze and all croud control spells except polymorph are not removed
#define MECHANIC_NOT_REMOVED_BY_SHAPESHIFT ((1 << (MECHANIC_CHARM - 1)) | (1 << (MECHANIC_DISORIENTED - 1)) | (1 << (MECHANIC_FEAR - 1)) | (1 << (MECHANIC_PACIFY - 1)) | (1 << (MECHANIC_STUN - 1)) | (1 << (MECHANIC_FREEZE - 1)) | (1 << (MECHANIC_BANISH - 1)) | (1 << (MECHANIC_SHACKLE - 1)) | (1 << (MECHANIC_HORROR - 1)) | (1 << (MECHANIC_TURN - 1)) | (1 << (MECHANIC_DAZE - 1)) | (1 << (MECHANIC_SAPPED - 1)))
...
#define SPELL_SCHOOL_MASK_MAGIC (SPELL_SCHOOL_MASK_HOLY | SPELL_SCHOOL_MASK_FIRE | SPELL_SCHOOL_MASK_NATURE | SPELL_SCHOOL_MASK_FROST | SPELL_SCHOOL_MASK_SHADOW | SPELL_SCHOOL_MASK_ARCANE)

// converts school value into schoolmask missing in 1.12 dbc
inline SpellSchoolMask GetSchoolMask(uint32 school) { return SpellSchoolMask(1 << school); }
...
enum SpellAttributesEx3
{
    ...
    SPELL_ATTR_EX3_NO_RES_TIMER = 0x00000010, // 4 Corpse reclaim delay does not apply to accepting resurrection
...
#define MELEE_BASED_TRIGGER_MASK (PROC_FLAG_DEAL_MELEE_SWING | PROC_FLAG_TAKE_MELEE_SWING | PROC_FLAG_DEAL_MELEE_ABILITY | PROC_FLAG_TAKE_MELEE_ABILITY | PROC_FLAG_DEAL_RANGED_ATTACK | PROC_FLAG_TAKE_RANGED_ATTACK | PROC_FLAG_DEAL_RANGED_ABILITY | PROC_FLAG_TAKE_RANGED_ABILITY)

#define NEGATIVE_TRIGGER_MASK (MELEE_BASED_TRIGGER_MASK | PROC_FLAG_DEAL_HARMFUL_ABILITY | PROC_FLAG_TAKE_HARMFUL_ABILITY | PROC_FLAG_DEAL_HARMFUL_SPELL | PROC_FLAG_TAKE_HARMFUL_SPELL)
...
#define PROX_EX_NO_DAMAGE_MASK (PROC_EX_MISS | PROC_EX_RESIST | PROC_EX_DODGE | PROC_EX_PARRY | PROC_EX_BLOCK | PROC_EX_EVADE | PROC_EX_IMMUNE | PROC_EX_DEFLECT | PROC_EX_ABSORB | PROC_EX_REFLECT)
