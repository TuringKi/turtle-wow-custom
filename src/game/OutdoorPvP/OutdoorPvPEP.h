...
const creature_type EP_BufferNPCs[8] = {{NPC_TOWER_BUFFER_ALLIANCE, 469, 0, 1860.59f, -3730.8f, 197.854f, 2.54818f}, {NPC_TOWER_BUFFER_ALLIANCE, 469, 0, 2574.12f, -4795.33f, 145.871f, 5.11381f}, {NPC_TOWER_BUFFER_ALLIANCE, 469, 0, 2962.6f, -3041.96f, 155.835f, 3.00197f}, {NPC_TOWER_BUFFER_ALLIANCE, 469, 0, 3180.54f, -4379.31f, 175.275f, 3.57792f}, {NPC_TOWER_BUFFER_HORDE, 67, 0, 1860.48f, -3731.34f, 197.778f, 2.42601f}, {NPC_TOWER_BUFFER_HORDE, 67, 0, 2574.0f, -4794.79f, 145.881f, 1.95477f}, {NPC_TOWER_BUFFER_HORDE, 67, 0, 2963.02f, -3041.9f, 155.965f, 4.27606f}, {NPC_TOWER_BUFFER_HORDE, 67, 0, 3180.48f, -4379.07f, 174.995f, 2.74017f}};

const go_type EP_CapturePoints[TOWER_NUMBER] = {{GOBJECT_DOODAD_BATTLEFIELDBANNER_STATE_BASE_PLAGUELANDS03, 0, 2574.51f, -4794.89f, 144.704f, -1.45003f, -0.097056f, 0.095578f, -0.656229f, 0.742165f}, {GOBJECT_DOODAD_BATTLEFIELDBANNER_STATE_BASE_PLAGUELANDS01, 0, 3181.08f, -4379.36f, 174.123f, -2.03472f, -0.065392f, 0.119494f, -0.842275f, 0.521553f}, {GOBJECT_DOODAD_BATTLEFIELDBANNER_STATE_BASE_PLAGUELANDS04, 0, 2962.71f, -3042.31f, 154.789f, 2.08426f, -0.074807f, -0.113837f, 0.855928f, 0.49883f}, {GOBJECT_DOODAD_BATTLEFIELDBANNER_STATE_BASE_PLAGUELANDS02, 0, 1860.85f, -3731.23f, 196.716f, -2.53214f, 0.033967f, -0.131914f, 0.944741f, -0.298177f}};

const go_type EP_TowerFlags[BANNER_NUMBER] = {{GOBJECT_TOWER_BANNER, 0, 1838.42f, -3703.56f, 167.713f, 0.890117f, 0.0f, 0.0f, 0.43051f, 0.902586f}, {GOBJECT_TOWER_BANNER, 0, 1877.6f, -3716.76f, 167.188f, 1.74533f, 0.0f, 0.0f, 0.766044f, 0.642789f}, {GOBJECT_TOWER_BANNER, 0, 2539.61f, -4801.55f, 115.766f, 2.00713f, 0.0f, 0.0f, 0.843391f, 0.5373f}, {GOBJECT_TOWER_BANNER, 0, 2569.6f, -4772.93f, 115.399f, 2.72271f, 0.0f, 0.0f, 0.978148f, 0.207912f}, {GOBJECT_TOWER_BANNER, 0, 2975.5f, -3060.36f, 125.108f, 5.23599f, 0.0f, 0.0f, -0.5f, 0.866025f}, {GOBJECT_TOWER_BANNER, 0, 2992.63f, -3022.95f, 125.593f, 3.03684f, 0.0f, 0.0f, 0.998629f, 0.0523532f}, {GOBJECT_TOWER_BANNER, 0, 3148.17f, -4365.51f, 145.029f, 1.53589f, 0.0f, 0.0f, 0.694658f, 0.71934f}, {GOBJECT_TOWER_BANNER, 0, 3188.76f, -4358.5f, 144.555f, 1.97222f, 0.0f, 0.0f, 0.833885f, 0.551938f}};
...
const go_type EP_NPT_LordaeronShrine[4] = {{GOBJECT_CURING_SHRINE_ALLIANCE, 0, 3167.72f, -4355.91f, 138.785f, 1.69297f, 0.0f, 0.0f, 0.748956f, 0.66262f}, {GOBJECT_BANNER_AURA_ALLIANCE, 0, 3167.72f, -4355.91f, 138.785f, 1.69297f, 0.0f, 0.0f, 0.748956f, 0.66262f}, {GOBJECT_CURING_SHRINE_HORDE, 0, 3167.5f, -4356.25f, 138.821f, 1.69297f, 0.0f, 0.0f, 0.748956f, 0.66262f}, {GOBJECT_BANNER_AURA_HORDE, 0, 3167.5f, -4356.25f, 138.821f, 1.69297f, 0.0f, 0.0f, 0.748956f, 0.66262f}};

const go_type EP_CGT_BannerAuraGraveYard[2] = {{GOBJECT_BANNER_AURA_LARGE_HORDE, 0, 1985.47f, -3653.88f, 120.172f, 1.46608f, 0.0f, 0.0f, 0.66913f, 0.743145f}, {GOBJECT_BANNER_AURA_LARGE_ALLIANCE, 0, 1985.47f, -3653.88f, 120.172f, 1.46608f, 0.0f, 0.0f, 0.66913f, 0.743145f}};

const creature_type EP_EWT_Summons_A[EP_SummonsNum] = {{NPC_LORDAERON_COMMANDER, 469, 0, 2532.85f, -4764.92f, 103.617f, 2.35619f}, {NPC_LORDAERON_SOLDIER, 469, 0, 2533.33f, -4769.31f, 104.396f, 2.37365f}, {NPC_LORDAERON_SOLDIER, 469, 0, 2537.34f, -4773.92f, 105.941f, 2.21657f}, {NPC_LORDAERON_SOLDIER, 469, 0, 2537.77f, -4765.94f, 104.432f, 2.3911f}, {NPC_LORDAERON_SOLDIER, 469, 0, 2542.57f, -4770.22f, 106.145f, 2.42601f}};

const creature_type EP_EWT_Summons_H[EP_SummonsNum] = {{NPC_LORDAERON_VETERAN, 67, 0, 2532.85f, -4764.92f, 103.617f, 2.35619f}, {NPC_LORDAERON_FIGHTER, 67, 0, 2533.33f, -4769.31f, 104.396f, 2.37365f}, {NPC_LORDAERON_FIGHTER, 67, 0, 2537.34f, -4773.92f, 105.941f, 2.21657f}, {NPC_LORDAERON_FIGHTER, 67, 0, 2537.77f, -4765.94f, 104.432f, 2.3911f}, {NPC_LORDAERON_FIGHTER, 67, 0, 2542.57f, -4770.22f, 106.145f, 2.42601f}};
...
public:
    ...
    void HandlePlayerLeave(Player* plr, bool bJustDestroy);
...
public:
    ...
    void OnPlayerLeave(Player* plr, bool bJustDestroy);
