...
public:
    ...
    uint32 GetAreaId(uint32 mapid, float x, float y, float z) const { return GetAreaIdByAreaFlag(GetAreaFlag(mapid, x, y, z), mapid); }
    uint32 GetZoneId(uint32 mapid, float x, float y, float z) const { return GetZoneIdByAreaFlag(GetAreaFlag(mapid, x, y, z), mapid); }
    void GetZoneAndAreaId(uint32& zoneid, uint32& areaid, uint32 mapid, float x, float y, float z) { GetZoneAndAreaIdByAreaFlag(zoneid, areaid, GetAreaFlag(mapid, x, y, z), mapid); }
