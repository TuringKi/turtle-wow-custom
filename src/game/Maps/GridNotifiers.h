...
namespace MaNGOS
{
    ...
    struct MessageDelivererExcept
    {
        ...
        MessageDelivererExcept(WorldPacket* msg, Player const* skipped) : i_message(msg), i_skipped_receiver(skipped) {}
    ...
    struct MessageDistDeliverer
    {
        ...
        MessageDistDeliverer(Player const& pl, WorldPacket* msg, float dist, bool to_self, bool ownTeamOnly) : i_player(pl), i_message(msg), i_toSelf(to_self), i_ownTeamOnly(ownTeamOnly), i_dist(dist) {}
        void Visit(CameraMapType& m);
        template <class SKIP>
        void Visit(GridRefManager<SKIP>&)
        {
    ...
    struct DynamicObjectUpdater
    {
        ...
        template <class T>
        inline void Visit(GridRefManager<T>&)
        {
        }
#ifdef _MSC_VER
        template <>
        inline void Visit<Player>(PlayerMapType&);
        template <>
        inline void Visit<Creature>(CreatureMapType&);
#endif
    ...
    */
    ...
    public:
        ...
        {
            if (i_fobj->IsFriendlyTo(u) || u->IsAlive() || u->IsTaxiFlying() || (u->GetCreatureTypeMask() & CREATURE_TYPEMASK_HUMANOID_OR_UNDEAD) == 0 || !i_fobj->CanSeeInWorld(u))
                return false;
    ...
    public:
        ...
        WorldObject const& GetFocusObject() const { return *i_fobj; }
        bool operator()(Corpse* u) { return i_fobj->IsWithinDistInMap(u, i_range); }
    ...
    {
    public:
        NearestInteractableNpcWithFlag(Player const* obj, uint32 npcFlags) : i_obj(obj), i_npcFlags(npcFlags), i_range(INTERACTION_DISTANCE) {}
        WorldObject const& GetFocusObject() const { return *i_obj; }
    ...
    {
    public:
        NearestGameObjectEntryInPosRangeCheck(WorldObject const& obj, uint32 entry, float x, float y, float z, float range) : i_obj(obj), i_entry(entry), i_x(x), i_y(y), i_z(z), i_range(range) {}
    ...
    {
    public:
        GameObjectEntryInPosRangeCheck(WorldObject const& obj, uint32 entry, float x, float y, float z, float range) : i_obj(obj), i_entry(entry), i_x(x), i_y(y), i_z(z), i_range(range) {}

        WorldObject const& GetFocusObject() const { return i_obj; }

        bool operator()(GameObject* go) { return go->GetEntry() == i_entry && go->IsWithinDist3d(i_x, i_y, i_z, i_range); }
    ...
    public:
        ...
        {
            if (u->IsAlive() && (i_obj->IsInCombat() == u->IsInCombat()) && i_obj->IsFriendlyTo(u) && i_obj->IsWithinDistInMap(u, i_range))
            {
                if (i_percent)
    ...
    public:
        ...
        WorldObject const& GetFocusObject() const { return *i_obj; }
        bool operator()(Unit* u) { return u->IsAlive() && u->IsInCombat() && !i_obj->IsHostileTo(u) && i_obj->IsWithinDistInMap(u, i_range) && (u->IsCharmed() || u->IsFrozen() || u->HasUnitState(UNIT_STAT_CAN_NOT_REACT)); }
    ...
    public:
        ...
        WorldObject const& GetFocusObject() const { return *i_obj; }
        bool operator()(Unit* u) { return u->IsAlive() && u->IsInCombat() && !i_obj->IsHostileTo(u) && i_obj->IsWithinDistInMap(u, i_range) && !(u->HasAura(i_spell, EFFECT_INDEX_0) || u->HasAura(i_spell, EFFECT_INDEX_1) || u->HasAura(i_spell, EFFECT_INDEX_2)); }
    ...
    {
    public:
        AnyUnfriendlyVisibleUnitInObjectRangeCheck(WorldObject const* obj, Unit const* funit, float range) : i_obj(obj), i_funit(funit), i_range(range) {}
        WorldObject const& GetFocusObject() const { return *i_obj; }
        bool operator()(Unit* u) { return u->IsAlive() && i_obj->IsWithinDistInMap(u, i_range) && !i_funit->IsFriendlyTo(u) && u->IsVisibleForOrDetect(i_funit, i_funit, false); }
    ...
    public:
        ...
        WorldObject const& GetFocusObject() const { return *i_obj; }
        bool operator()(Unit* u) { return u->IsAlive() && i_obj->IsWithinDistInMap(u, i_range) && i_obj->IsFriendlyTo(u) && u->CanSeeInWorld(i_obj); }
    ...
    public:
        ...
        WorldObject const& GetFocusObject() const { return *i_obj; }
        bool operator()(Unit* u) { return u->IsAlive() && i_obj->IsWithinDistInMap(u, i_range) && u->CanSeeInWorld(i_obj); }
    ...
    public:
        ...
        bool operator()(Unit* u)
        {
            ...
            if (i_obj->IsWithinDistInMap(u, i_range) && i_funit->IsValidAttackTarget(u) && u->IsVisibleForOrDetect(i_funit, i_funit, false) && i_funit->IsHostileTo(u))
            {
                i_range = i_obj->GetDistance(u); // use found unit range as new range limit for next check
                return true;
            }
    ...
    {
    public:
        AnyAoEVisibleTargetUnitInObjectRangeCheck(WorldObject const* obj, WorldObject const* originalCaster, float range) : i_obj(obj), i_originalCaster(originalCaster), i_range(range) {}
        WorldObject const& GetFocusObject() const { return *i_obj; }
        bool operator()(Unit* u)
        {
    ...
    {
    public:
        AnyAoETargetUnitInObjectRangeCheck(WorldObject const* obj, WorldObject const* originalCaster, float range) : i_obj(obj), i_originalCaster(originalCaster), i_range(range) {}
        WorldObject const& GetFocusObject() const { return *i_obj; }
        bool operator()(Unit* u)
        {
            // ignore totems as AoE targets
    ...
    {
    public:
        NearestFriendlyGuardInRangeCheck(Creature const* obj, float range) : i_obj(obj), i_range(range) {}
        WorldObject const& GetFocusObject() const { return *i_obj; }
        bool operator()(Creature const* u)
        {
            if (u == i_obj)
    ...
    {
    public:
        NearestCreatureEntryWithLiveStateInObjectRangeCheck(WorldObject const& obj, uint32 entry, bool alive, float range, Creature const* except = nullptr) : i_obj(obj), i_entry(entry), i_alive(alive), i_range(range), i_except(except) {}
        WorldObject const& GetFocusObject() const { return i_obj; }
        bool operator()(Creature* u)
        {
    ...
    {
    public:
        NearestCreatureEntryFitConditionInObjectRangeCheck(WorldObject const& obj, uint32 entry, bool alive, float range, uint32 conditionId) : i_obj(obj), i_entry(entry), i_alive(alive), i_range(range), i_conditionId(conditionId) {}
        WorldObject const& GetFocusObject() const { return i_obj; }
        bool operator()(Creature* u)
        {
    ...
    {
    public:
        AnyPlayerInObjectRangeWithAuraCheck(WorldObject const* obj, float range, uint32 spellId) : i_obj(obj), i_range(range), i_spellId(spellId) {}
        WorldObject const& GetFocusObject() const { return *i_obj; }
        bool operator()(Player* u) { return u->IsAlive() && i_obj->IsWithinDistInMap(u, i_range) && u->HasAura(i_spellId); }
    ...
    public:
        ...
        bool operator()(Unit* u) { return u->IsAlive() && u->GetVisibility() == VISIBILITY_ON && u->IsFriendlyTo(pUnit); }
    ...
    public:
        ...
        bool operator()(GameObject* pGo) { return pGo->GetEntry() == m_uiEntry && m_pObject->IsWithinDist(pGo, m_fRange, false); }
    ...
    {
    public:
        AllGameObjectsInRange(const WorldObject* pObject, float fMaxRange) : m_pObject(pObject), m_fRange(fMaxRange) {}
        bool operator()(GameObject* pGo) { return m_pObject->IsWithinDist(pGo, m_fRange, false); }
    ...
    public:
        ...
        bool operator()(Unit* pUnit) { return pUnit->GetEntry() == m_uiEntry && m_pObject->IsWithinDist(pUnit, m_fRange, false); }
    ...
    public:
        ...
        bool operator()(Unit* pUnit) { return m_pObject->IsWithinDist(pUnit, m_fRange, false); }
    ...
    {
    public:
        AllCreaturesMatchingOneEntryInRange(const WorldObject* pObject, const std::vector<uint32>& entries, float fMaxRange) : m_pObject(pObject), entries(entries), m_fRange(fMaxRange) {}
        bool operator()(Unit* pUnit)
        {
    ...
    {
    public:
        explicit NearestUnitCheck(WorldObject const* source, float dist = 0) : me(source) { m_range = (dist == 0 ? 9999 : dist); }
        bool operator()(Unit* u)
        {
            if (me == u)
                return false;
    ...
    {
    public:
        explicit NearestFriendlyUnitCheck(Unit const* source, float dist = 0) : me(source) { m_range = (dist == 0 ? 9999 : dist); }
        bool operator()(Unit* u)
        {
            if (me == u)
                return false;
    ...
    {
    public:
        explicit NearestHostileUnitCheck(Unit const* source, float dist = 0) : me(source) { m_range = (dist == 0 ? 9999 : dist); }
        bool operator()(Unit* u)
        {
            if (me == u)
                return false;
    ...
    {
    public:
        explicit NearestHostileUnitInAggroRangeCheck(Creature const* creature, bool useLOS = false, bool ignoreCivilians = false) : m_me(creature), m_useLOS(useLOS), m_ignoreCivilians(ignoreCivilians) { m_dist = 9999; }
    ...
    public:
        ...
        bool operator()(WorldObject* go) { return m_pObject->IsWithinDist(go, m_fRange, false); }
    ...
    public:
        ...
        bool operator()(WorldObject* object) { return (object->GetTypeId() == _typeId) == _equals; }
    ...
    public:
        ...
        bool operator()(WorldObject* object) { return object->GetGUID() == _GUID; }
...
#ifndef WIN32
    template <>
    void PlayerRelocationNotifier::Visit<Creature>(CreatureMapType&);
    template <>
    void CreatureRelocationNotifier::Visit<Player>(PlayerMapType&);
    template <>
    void CreatureRelocationNotifier::Visit<Creature>(CreatureMapType&);
    template <>
    inline void DynamicObjectUpdater::Visit<Creature>(CreatureMapType&);
    template <>
    inline void DynamicObjectUpdater::Visit<Player>(PlayerMapType&);
#endif
} // namespace MaNGOS
#endif
