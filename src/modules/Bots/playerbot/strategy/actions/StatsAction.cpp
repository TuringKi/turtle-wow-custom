...
void StatsAction::ListGold(ostringstream& out) { out << chat->formatMoney(bot->GetMoney()); }
...
void StatsAction::ListXP(ostringstream& out)
{
    ...
    out << "|r|cff00ff00" << xpPercent << "|r|cffffd333%"
        << "|h|cffffffff XP";
}

void StatsAction::ListRepairCost(ostringstream& out) { out << chat->formatMoney(EstRepairAll()) << " Repair"; }
