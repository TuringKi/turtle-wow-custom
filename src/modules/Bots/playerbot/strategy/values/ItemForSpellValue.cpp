...
Item* ItemForSpellValue::Calculate()
{
    ...
    if (!strcmpi(spellInfo->SpellName[0].c_str(), "rockbiter weapon") || !strcmpi(spellInfo->SpellName[0].c_str(), "flametongue weapon") || !strcmpi(spellInfo->SpellName[0].c_str(), "earthliving weapon") || !strcmpi(spellInfo->SpellName[0].c_str(), "frostbrand weapon") || !strcmpi(spellInfo->SpellName[0].c_str(), "windfury weapon"))
    {
