...
namespace ahbot
{
    ...
    public:
        virtual bool Contains(ItemPrototype const* proto) { return proto->Class == ITEM_CLASS_CONSUMABLE; }

        virtual string GetName() { return "consumable"; }

        virtual uint32 GetMaxAllowedItemAuctionCount(ItemPrototype const* proto) { return 10; }
    ...
    public:
        virtual bool Contains(ItemPrototype const* proto) { return proto->Class == ITEM_CLASS_QUEST; }
        virtual string GetName() { return "quest"; }

        virtual uint32 GetMaxAllowedItemAuctionCount(ItemPrototype const* proto) { return 5; }
    ...
    public:
        virtual bool Contains(ItemPrototype const* proto) { return proto->Class == ITEM_CLASS_TRADE_GOODS; }
    ...
    public:
        virtual bool Contains(ItemPrototype const* proto) { return proto->Class == ITEM_CLASS_REAGENT && proto->ItemLevel > 1; }
    ...
    public:
        virtual bool Contains(ItemPrototype const* proto) { return proto->Class == ITEM_CLASS_RECIPE && proto->ItemLevel > 1; }
        virtual string GetName() { return "recipe"; }
        virtual uint32 GetMaxAllowedItemAuctionCount(ItemPrototype const* proto) { return 1; }

        virtual uint32 GetStackCount(ItemPrototype const* proto) { return 1; }
    };
    ...
    public:
        virtual bool Contains(ItemPrototype const* proto) { return (proto->Class == ITEM_CLASS_WEAPON || proto->Class == ITEM_CLASS_ARMOR) && proto->ItemLevel > 1; }
    ...
    public:
        virtual bool Contains(ItemPrototype const* proto) { return proto->Quality > ITEM_QUALITY_POOR && (proto->Class == ITEM_CLASS_JUNK) && proto->ItemLevel > 1; }
    ...
    public:
        virtual bool Contains(ItemPrototype const* proto) { return proto->Class == ITEM_CLASS_QUIVER && proto->ItemLevel > 1; }
    ...
    public:
        virtual bool Contains(ItemPrototype const* proto) { return proto->Class == ITEM_CLASS_PROJECTILE; }

        virtual string GetName() { return "projectile"; }

        virtual uint32 GetMaxAllowedItemAuctionCount(ItemPrototype const* proto) { return 5; }

        virtual uint32 GetStackCount(ItemPrototype const* proto) { return proto->GetMaxStackSize(); }
    };
    ...
    public:
        virtual bool Contains(ItemPrototype const* proto) { return proto->Class == ITEM_CLASS_CONTAINER && proto->ItemLevel > 1; }
