...
{
public:
    QueryResult(uint64 rowCount, uint32 fieldCount) : mCurrentRow(nullptr), mFieldCount(fieldCount), mRowCount(rowCount) { ++PerfStats::g_totalQueryResults; }

    virtual ~QueryResult() { --PerfStats::g_totalQueryResults; }
