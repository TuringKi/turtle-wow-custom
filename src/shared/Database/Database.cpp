...
//////////////////////////////////////////////////////////////////////////
SqlPreparedStatement* SqlConnection::CreateStatement(const std::string& fmt) { return new SqlPlainPreparedStatement(fmt, *this); }
...
bool Database::InitDelayThread(const char* Name, std::string const& infoString)
{
    ...
    m_delayThreads.emplace_back([tbody]() { tbody->run(); });
...
bool Database::InTransaction() { return m_TransStorage->get() != nullptr; }
...
Database::TransHelper::~TransHelper() { reset(); }
