...
protected:
    Database() : m_nQueryConnPoolSize(1), m_delayQueue(new SqlQueue()), m_pAsyncConn(nullptr), m_pResultQueue(nullptr), m_numAsyncWorkers(0), m_bAllowAsyncTransactions(false), m_iStmtIndex(-1), m_logSQL(false), m_pingIntervallms(0) { m_nQueryCounter = -1; }
