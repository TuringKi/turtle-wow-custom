...
QueryResultPostgre::QueryResultPostgre(PGresult* result, uint64 rowCount, uint32 fieldCount) : QueryResult(rowCount, fieldCount), mResult(result), mTableIndex(0)
{
...
QueryResultPostgre::~QueryResultPostgre() { EndQuery(); }
