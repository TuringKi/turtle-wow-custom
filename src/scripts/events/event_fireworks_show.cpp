...
struct go_cheer_speakerAI : public GameObjectAI
{
    ...
    uint32 FireworksPicker() { return SelectRandomContainerElement(fireworkIds); }

    uint32 FireworksBIGOnlyPicker() { return SelectRandomContainerElement(fireworkBigIds); }
...
GameObjectAI* GetAI_go_cheer_speaker(GameObject* gameobject) { return new go_cheer_speakerAI(gameobject); }
