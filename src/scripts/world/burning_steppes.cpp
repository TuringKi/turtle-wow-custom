...
CreatureAI* GetAI_npc_grark_lorkrub(Creature* pCreature) { return new npc_grark_lorkrubAI(pCreature); }
...
struct npc_klinfranAI : public ScriptedAI
{
    ...
    void JustDied(Unit* /*pKiller*/) override { m_creature->SetHomePosition(-8318.19f, -993.662f, 176.956f, 5.65024f); }
...
CreatureAI* GetAI_npc_klinfran(Creature* pCreature) { return new npc_klinfranAI(pCreature); }
