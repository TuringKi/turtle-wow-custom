...
float Position[10][3] = {{-52.9f, 269.8f, -92.8f}, {-58.5f, 279.8f, -92.8f}, {-49.6f, 278.2f, -92.8f}, {142.7f, 254.0f, -102.2f}, {140.5f, 219.8f, -102.4f}, {92.2f, 261.9f, -101.5f}, {100.3f, 268.6f, -102.2f}, {123.8f, 271.9f, -102.4f}, {151.9f, 234.3f, -102.5f}, {127.6f, 200.8f, -101.8f}};
...
struct npc_disciple_of_naralexAI : public npc_escortAI
{
    ...
    void SummonAttacker(uint32 entry, float x, float y, float z) { m_creature->SummonCreature(entry, x, y, z, 0, TEMPSUMMON_DEAD_DESPAWN); }
    ...
    void SendAttackerToMe(Creature* pCreature)
    {
        ...
        if (pCreature->GetEntry() == MOB_DEVIATE_RAPTOR || pCreature->GetEntry() == MOB_DEVIATE_VIPER)
...
CreatureAI* GetAI_npc_disciple_of_naralex(Creature* pCreature) { return new npc_disciple_of_naralexAI(pCreature); }
...
{
    EvolvingEctoplasmAI(Creature* pCreature) : ScriptedAI(pCreature) { Reset(); }
...
CreatureAI* GetAI_EvolvingEctoplasmAI(Creature* pCreature) { return new EvolvingEctoplasmAI(pCreature); }
