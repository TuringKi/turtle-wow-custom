...
struct boss_brood_queen_araxxnaAI : public ScriptedAI
{
    ...
    void JustSummoned(Creature* summon) override { summonList.push_back(summon->GetObjectGuid()); }
...
CreatureAI* GetAI_boss_brood_queen_araxxna(Creature* pCreature) { return new boss_brood_queen_araxxnaAI(pCreature); }
...
struct skitterweb_eggAI : public Scripted_NoMovementAI
{
    ...
    void Reset() override { m_SpawnTimer = 20 * IN_MILLISECONDS; }
...
CreatureAI* GetAI_skitterweb_egg(Creature* pCreature) { return new skitterweb_eggAI(pCreature); }
