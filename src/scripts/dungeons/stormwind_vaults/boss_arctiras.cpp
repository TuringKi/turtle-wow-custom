...
struct boss_ArctirasAI : public GenericSpellMob
{
    ...
    explicit boss_ArctirasAI(Creature* c) : GenericSpellMob(c)
    {
...
CreatureAI* GetAI_major_resonating_crystal(Creature* pCreature) { return new boss_ArctirasAI(pCreature); }
