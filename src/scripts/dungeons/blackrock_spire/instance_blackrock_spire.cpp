...
static const uint32 aStadiumSpectators[12] = {NPC_BLACKHAND_VETERAN, NPC_BLACKHAND_VETERAN, NPC_BLACKHAND_VETERAN, NPC_BLACKHAND_ELITE, NPC_BLACKHAND_VETERAN, NPC_BLACKHAND_VETERAN, NPC_BLACKHAND_VETERAN, NPC_BLACKHAND_VETERAN, NPC_BLACKHAND_VETERAN, NPC_BLACKHAND_ELITE, NPC_BLACKHAND_VETERAN, NPC_BLACKHAND_VETERAN};

static const Position aSpectatorsSpawnLocs[12] = {
    {163.3209f, -340.9818f, 111.0216f, 4.818223f}, {164.2471f, -339.0313f, 111.0368f, 1.413717f}, {161.124f, -339.5178f, 111.0381f, 3.001966f}, {162.5045f, -337.8101f, 111.0367f, 4.13643f}, {160.9896f, -337.7715f, 111.0368f, 1.117011f}, {161.8347f, -335.7923f, 111.0352f, 2.286381f}, {113.9726f, -366.0805f, 116.9195f, 6.252025f}, {112.7245f, -368.9635f, 116.9307f, 4.677482f}, {110.5757f, -368.2123f, 116.9278f, 4.310963f}, {109.3343f, -366.4785f, 116.9261f, 2.740167f}, {110.1331f, -363.9824f, 116.9272f, 0.5235988f}, {111.9971f, -363.0948f, 116.929f, 5.951573f},
};

static const Position aSpectatorsTargetLocs[12] = {
    {160.619f, -395.826f, 121.9752f, -1.502597f}, {162.1428f, -395.1175f, 121.9751f, -1.67753f}, {158.6822f, -395.7097f, 121.9753f, -1.787977f}, {164.384f, -395.3787f, 121.9751f, -1.502597f}, {156.9669f, -395.2188f, 121.9752f, -1.678662f}, {166.2515f, -395.0366f, 121.975f, -1.791467f}, {143.814f, -396.7092f, 121.9753f, -1.40136f}, {145.3893f, -396.1959f, 121.9752f, -1.419479f}, {142.1598f, -396.0284f, 121.9752f, -1.661444f}, {147.7274f, -396.3042f, 121.9753f, -1.40136f}, {139.9446f, -396.7277f, 121.9753f, -1.428414f}, {149.3754f, -395.7497f, 121.9753f, -1.714769f},
};
...
static const uint32 aStadiumEventNpcs[MAX_STADIUM_WAVES][MAX_STADIUM_MOBS_PER_WAVE] = {
    {NPC_CHROMATIC_WHELP, NPC_CHROMATIC_WHELP, NPC_CHROMATIC_WHELP, NPC_CHROMATIC_DRAGON, 0}, {NPC_CHROMATIC_WHELP, NPC_CHROMATIC_WHELP, NPC_CHROMATIC_WHELP, NPC_CHROMATIC_DRAGON, 0}, {NPC_CHROMATIC_WHELP, NPC_CHROMATIC_WHELP, NPC_CHROMATIC_DRAGON, NPC_BLACKHAND_HANDLER, 0}, {NPC_CHROMATIC_WHELP, NPC_CHROMATIC_WHELP, NPC_CHROMATIC_DRAGON, NPC_BLACKHAND_HANDLER, 0}, {NPC_CHROMATIC_WHELP, NPC_CHROMATIC_WHELP, NPC_CHROMATIC_WHELP, NPC_CHROMATIC_DRAGON, NPC_BLACKHAND_HANDLER}, {NPC_CHROMATIC_WHELP, NPC_CHROMATIC_WHELP, NPC_CHROMATIC_DRAGON, NPC_CHROMATIC_DRAGON, NPC_BLACKHAND_HANDLER}, {NPC_CHROMATIC_WHELP, NPC_CHROMATIC_WHELP, NPC_CHROMATIC_DRAGON, NPC_CHROMATIC_DRAGON, NPC_BLACKHAND_HANDLER},
};

static const SIDialogueEntry aStadiumDialogue[] = {
    {NPC_LORD_VICTOR_NEFARIUS, 0, 1000}, {SAY_NEFARIUS_INTRO_1, NPC_LORD_VICTOR_NEFARIUS, 7000}, {SAY_NEFARIUS_INTRO_2, NPC_LORD_VICTOR_NEFARIUS, 5000}, {NPC_BLACKHAND_HANDLER, 0, 0}, {SAY_NEFARIUS_LOSE1, NPC_LORD_VICTOR_NEFARIUS, 3000}, {SAY_REND_ATTACK, NPC_REND_BLACKHAND, 2000}, {SAY_NEFARIUS_WARCHIEF, NPC_LORD_VICTOR_NEFARIUS, 3000}, {SAY_NEFARIUS_PACING, NPC_LORD_VICTOR_NEFARIUS, 0}, {SAY_NEFARIUS_VICTORY, NPC_LORD_VICTOR_NEFARIUS, 5000}, {NPC_REND_BLACKHAND, 0, 0}, {0, 0, 0},
};

instance_blackrock_spire::instance_blackrock_spire(Map* pMap) :
    ScriptedInstance(pMap), DialogueHelper(aStadiumDialogue), m_uiEmberseerGUID(0), m_uiNefariusGUID(0), m_uiRendGUID(0), m_uiGythGUID(0), m_uiInfiltratorGUID(0), m_uiDrakkisathGUID(0),

    m_uiEmberseerInDoorGUID(0), m_uiEmberseerCombatDoorGUID(0), m_uiEmberseerOutDoorGUID(0),

    m_uiGythEntryDoorGUID(0), m_uiGythCombatDoorGUID(0), m_uiGythExitDoorGUID(0),

    m_uiFatherFlameGUID(0), m_uiFatherFlame_timer(0), m_uiFatherFlame_WaveCount(0),

    m_uiUBRSDoorGUID(0), m_uiBrazier01GUID(0), m_uiBrazier02GUID(0), m_uiBrazier03GUID(0), m_uiBrazier04GUID(0), m_uiBrazier05GUID(0), m_uiBrazier06GUID(0),

    m_uiEmberseerRune01GUID(0), m_uiEmberseerRune02GUID(0), m_uiEmberseerRune03GUID(0), m_uiEmberseerRune04GUID(0), m_uiEmberseerRune05GUID(0), m_uiEmberseerRune06GUID(0), m_uiEmberseerRune07GUID(0),

    m_uiBlackRockAltarGUID(0),

    m_uiUBRSDoor_Timer(0), m_uiUBRSDoor_Step(0),

    m_uiStadiumEventTimer(0), m_uiStadiumWaves(0), m_uiStadiumMobsAlive(0),
...
void instance_blackrock_spire::OnCreatureDeath(Creature* pCreature)
{
    ...
    case NPC_BLACKHAND_HANDLER:
        ...
        if (urand(0, 100) < 5)
        {
            if (Creature* pNefarius = GetCreature(m_uiNefariusGUID))
            {
                uint32 const textId = PickRandomValue(SAY_NEFARIUS_TAUNT1, SAY_NEFARIUS_TAUNT2, SAY_NEFARIUS_TAUNT3, SAY_NEFARIUS_TAUNT4, SAY_NEFARIUS_TAUNT5, SAY_NEFARIUS_TAUNT6, SAY_NEFARIUS_TAUNT7, SAY_NEFARIUS_TAUNT8);
...
void instance_blackrock_spire::Update(uint32 uiDiff)
{
    ...
    if (GetData(TYPE_SOLAKAR) == IN_PROGRESS)
    {
        if (m_uiFatherFlame_timer <= uiDiff)
        {
            ...
            {
                Creature* pFirstHatcher = GetMap()->SummonCreature(NPC_ROOKERY_HATCHER, 55.232342f, -265.751282f, 93.883f, 5, TEMPSUMMON_DEAD_DESPAWN, HOUR * IN_MILLISECONDS);
                if (pFirstHatcher)
...
InstanceData* GetInstanceData_instance_blackrock_spire(Map* pMap) { return new instance_blackrock_spire(pMap); }
...
GameObjectAI* GetAIgo_father_flame(GameObject* pGo) { return new go_father_flameAI(pGo); }
