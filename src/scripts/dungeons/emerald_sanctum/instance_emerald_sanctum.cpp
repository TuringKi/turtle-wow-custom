...
instance_emerald_sanctum::instance_emerald_sanctum(Map* p_Map) : ScriptedInstance(p_Map) { instance_emerald_sanctum::Initialize(); }
...
InstanceData* GetInstanceData_instance_emerald_sanctum(Map* p_Map) { return new instance_emerald_sanctum(p_Map); }

struct sanctum_dreamerAI : public ScriptedAI
{
    sanctum_dreamerAI(Creature* pCreature) : ScriptedAI(pCreature) { Reset(); }

    uint32 m_uiDreamstateTimer;

    void Reset() override { m_uiDreamstateTimer = 10 * IN_MILLISECONDS; }
...
CreatureAI* GetAI_sanctum_dreamer(Creature* pCreature) { return new sanctum_dreamerAI(pCreature); }

struct sanctum_dragonkinAI : public ScriptedAI
{
    sanctum_dragonkinAI(Creature* pCreature) : ScriptedAI(pCreature) { Reset(); }

    uint32 m_uiReflectionTimer;

    void Reset() override { m_uiReflectionTimer = 10 * IN_MILLISECONDS; }
...
CreatureAI* GetAI_sanctum_dragonkin(Creature* pCreature) { return new sanctum_dragonkinAI(pCreature); }

struct sanctum_wyrmAI : public ScriptedAI
{
    sanctum_wyrmAI(Creature* pCreature) : ScriptedAI(pCreature) { Reset(); }
...
CreatureAI* GetAI_sanctum_wyrm(Creature* pCreature) { return new sanctum_wyrmAI(pCreature); }

struct sanctum_suppressorAI : public ScriptedAI
{
    sanctum_suppressorAI(Creature* pCreature) : ScriptedAI(pCreature) { Reset(); }

    uint32 m_uiEmeraldSupressionTimer;

    void Reset() override { m_uiEmeraldSupressionTimer = 15 * IN_MILLISECONDS; }
...
CreatureAI* GetAI_sanctum_supressor(Creature* pCreature) { return new sanctum_suppressorAI(pCreature); }

struct sanctum_wyrmkinAI : public ScriptedAI
{
    sanctum_wyrmkinAI(Creature* pCreature) : ScriptedAI(pCreature) { Reset(); }
...
CreatureAI* GetAI_sanctum_wyrmkin(Creature* pCreature) { return new sanctum_wyrmkinAI(pCreature); }

struct sanctum_scalebaneAI : public ScriptedAI
{
    sanctum_scalebaneAI(Creature* pCreature) : ScriptedAI(pCreature) { Reset(); }
...
CreatureAI* GetAI_sanctum_scalebane(Creature* pCreature) { return new sanctum_scalebaneAI(pCreature); }
...
CreatureAI* GetAI_erennius(Creature* pCreature) { return new erenniusAI(pCreature); }
