...
{
    explicit instance_molten_core(Map* pMap) : ScriptedInstance(pMap) { instance_molten_core::Initialize(); }
    ...
    const char* Save() override
    {
        ...
        saveStream << m_auiEncounter[0] << " " << m_auiEncounter[1] << " " << m_auiEncounter[2] << " " << m_auiEncounter[3] << " " << m_auiEncounter[4] << " " << m_auiEncounter[5] << " " << m_auiEncounter[6] << " " << m_auiEncounter[7] << " " << m_auiEncounter[8] << " " << m_auiEncounter[9] << " " << RuneActive[0] << " " << RuneActive[1] << " " << RuneActive[2] << " " << RuneActive[3] << " " << RuneActive[4] << " " << RuneActive[5] << " " << RuneActive[6];
    ...
    void Load(const char* chrIn) override
    {
        ...
        loadStream >> m_auiEncounter[0] >> m_auiEncounter[1] >> m_auiEncounter[2] >> m_auiEncounter[3] >> m_auiEncounter[4] >> m_auiEncounter[5] >> m_auiEncounter[6] >> m_auiEncounter[7] >> m_auiEncounter[8] >> m_auiEncounter[9] >> RuneActive[0] >> RuneActive[1] >> RuneActive[2] >> RuneActive[3] >> RuneActive[4] >> RuneActive[5] >> RuneActive[6];
...
bool GOHello_go_rune_MC(Player* pPlayer, GameObject* pGo)
{
    if (ScriptedInstance* pInstance = (ScriptedInstance*)pGo->GetInstanceData())
    {
        ...
        if (pInstance->GetData(TypeRuneActive0) == DONE && pInstance->GetData(TypeRuneActive1) == DONE && pInstance->GetData(TypeRuneActive2) == DONE && pInstance->GetData(TypeRuneActive3) == DONE && pInstance->GetData(TypeRuneActive4) == DONE && pInstance->GetData(TypeRuneActive5) == DONE && pInstance->GetData(TypeRuneActive6) == DONE && pInstance->GetData(TypeDomoSpawn) != DONE && pInstance->GetData(TYPE_RAGNAROS) != DONE)
        {
...
InstanceData* GetInstance_instance_molten_core(Map* pMap) { return new instance_molten_core(pMap); }
