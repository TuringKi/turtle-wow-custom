...
{
    static const LocationXYZO vfMoveTo[] = {{128.883f, -48.6615f, 15.99f, 1.55f}, {132.825f, -48.7298f, 15.99f, 1.55f}, {125.016f, -48.6871f, 15.99f, 1.55f}, {125.081f, -36.9308f, 15.99f, 1.55f}, {128.847f, -36.9513f, 15.99f, 1.55f}, {132.736f, -36.8489f, 15.99f, 1.55f}, {132.777f, -25.3095f, 15.99f, 1.55f}, {128.892f, -25.3187f, 15.99f, 1.55f}, {125.063f, -25.3278f, 15.99f, 1.55f}, {125.035f, -13.6799f, 15.99f, 1.55f}, {128.917f, -13.6573f, 15.99f, 1.55f}, {132.745f, -13.7459f, 15.99f, 1.55f}, {132.766f, -2.05773f, 15.99f, 1.55f}, {128.937f, -2.03679f, 15.99f, 1.55f}, {125.003f, -2.01526f, 15.99f, 1.55f}, {125.066f, 9.52406f, 15.99f, 1.55f}, {128.944f, 9.48699f, 15.99f, 1.55f}, {132.826f, 9.47718f, 15.99f, 1.55f}};

    static const LocationXYZO vfAddSpawn[] = {{147.f, -60.f, 17.f, 0.f}};

    static const float fAreatrigger[][5] = {{128.86f, -9.69f, 15.98f, 0.f, 12.f}};
    ...
    static const std::vector<std::pair<LocationXYZO, uint32>> pairlol{std::make_pair(nsERIC_VESPER::vfMoveTo[0], vTrashEntryList[0]), std::make_pair(nsERIC_VESPER::vfMoveTo[1], vTrashEntryList[1]),  std::make_pair(nsERIC_VESPER::vfMoveTo[2], vTrashEntryList[2]),  std::make_pair(nsERIC_VESPER::vfMoveTo[3], vTrashEntryList[0]),  std::make_pair(nsERIC_VESPER::vfMoveTo[4], vTrashEntryList[1]),  std::make_pair(nsERIC_VESPER::vfMoveTo[5], vTrashEntryList[2]),  std::make_pair(nsERIC_VESPER::vfMoveTo[6], vTrashEntryList[0]),  std::make_pair(nsERIC_VESPER::vfMoveTo[7], vTrashEntryList[1]),  std::make_pair(nsERIC_VESPER::vfMoveTo[8], vTrashEntryList[2]),
                                                                      std::make_pair(nsERIC_VESPER::vfMoveTo[9], vTrashEntryList[0]), std::make_pair(nsERIC_VESPER::vfMoveTo[10], vTrashEntryList[1]), std::make_pair(nsERIC_VESPER::vfMoveTo[11], vTrashEntryList[2]), std::make_pair(nsERIC_VESPER::vfMoveTo[12], vTrashEntryList[0]), std::make_pair(nsERIC_VESPER::vfMoveTo[13], vTrashEntryList[1]), std::make_pair(nsERIC_VESPER::vfMoveTo[14], vTrashEntryList[2]), std::make_pair(nsERIC_VESPER::vfMoveTo[15], vTrashEntryList[0]), std::make_pair(nsERIC_VESPER::vfMoveTo[16], vTrashEntryList[1]), std::make_pair(nsERIC_VESPER::vfMoveTo[17], vTrashEntryList[2])};
} // namespace nsERIC_VESPER
