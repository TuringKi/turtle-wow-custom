...
public:
    ...
    void SpawnSun()
    {
        if (Creature const* pSun{m_creature->SummonCreature(nsArdaeus::NPC_SUN, nsArdaeus::vfSunMovePoints[0].m_fX, nsArdaeus::vfSunMovePoints[0].m_fY, nsArdaeus::vfSunMovePoints[0].m_fZ, nsArdaeus::vfSunMovePoints[0].m_fO, TEMPSUMMON_MANUAL_DESPAWN)})
        {
    ...
    void CallForHelp(const uint32& uiDiff)
    {
        if (m_uiCallForHelp_Timer < uiDiff)
        {
            ...
            Creature* pStatueNPC{m_creature->SummonCreature(nsArdaeus::ARDAEUS_STATUE_NPC, nsArdaeus::vfStatueNPCsSpawnPoints[uiRnd].m_fX, nsArdaeus::vfStatueNPCsSpawnPoints[uiRnd].m_fY, nsArdaeus::vfStatueNPCsSpawnPoints[uiRnd].m_fZ, nsArdaeus::vfStatueNPCsSpawnPoints[uiRnd].m_fO, TEMPSUMMON_MANUAL_DESPAWN)};
            ...
            if (Creature * pRandomNPC{m_creature->SummonCreature(nsArdaeus::vfCallForHelpNPCs[uiRnd], nsArdaeus::vfCallForHelpSpawnPoint[0].m_fX, nsArdaeus::vfCallForHelpSpawnPoint[0].m_fY, nsArdaeus::vfCallForHelpSpawnPoint[0].m_fZ, nsArdaeus::vfCallForHelpSpawnPoint[0].m_fO, TEMPSUMMON_MANUAL_DESPAWN)})
            {
    ...
    void SpawnAchievementReward(Unit* pKiller)
    {
        if (pKiller)
        {
            pKiller->SummonGameObject(nsArdaeus::GO_ACHIEVEMENT_CHEST, nsArdaeus::vfAchievementChestSpawnPoint[0].m_fX, nsArdaeus::vfAchievementChestSpawnPoint[0].m_fY, nsArdaeus::vfAchievementChestSpawnPoint[0].m_fZ, nsArdaeus::vfAchievementChestSpawnPoint[0].m_fO, nsArdaeus::vfAchievementChestSpawnPoint[0].m_fR0, nsArdaeus::vfAchievementChestSpawnPoint[0].m_fR1, nsArdaeus::vfAchievementChestSpawnPoint[0].m_fR2, nsArdaeus::vfAchievementChestSpawnPoint[0].m_fR3, nsArdaeus::GO_ACHIEVEMENT_CHEST_DESPAWN_TIMER);
        }
        else
        {
    ...
    bool IsSunSpawned() { return static_cast<bool>(m_uiSunGuid); }
...
CreatureAI* GetAI_boss_ardaeus(Creature* pCreature) { return new boss_ardaeusAI(pCreature); }
...
public:
    ...
    void MoveDownwards()
    {
        ...
        m_creature->GetMotionMaster()->MovePoint(0, nsArdaeus::vfSunMovePoints[1].m_fX, nsArdaeus::vfSunMovePoints[1].m_fY, nsArdaeus::vfSunMovePoints[1].m_fZ, (MOVE_FLY_MODE), m_fDownwardSpeed);
    }
    ...
    void MoveUpwards()
    {
        ...
        m_creature->GetMotionMaster()->MovePoint(0, nsArdaeus::vfSunMovePoints[0].m_fX, nsArdaeus::vfSunMovePoints[0].m_fY, m_fNewPositionZ, (MOVE_FLY_MODE), m_fUpwardSpeed);
    ...
    void UpdateAI(const uint32 uiDiff) override
    {
        ...
        if (m_uiDamageDone > nsArdaeus::DAMAGE_DONE_TO_MOVE_UPWARDS && ((m_creature->GetPositionZ() + nsArdaeus::INCREASE_Z_AXIS) < nsArdaeus::vfSunMovePoints[0].m_fZ)) // Prevent to shoot the Sun through the roof
        {
            MoveUpwards();
        }
...
CreatureAI* GetAI_npc_sunAI(Creature* pCreature) { return new npc_sunAI(pCreature); }
...
{
    explicit npc_invar_onearmAI(Creature* pCreature) : ScriptedAI(pCreature) { npc_invar_onearmAI::Reset(); }
...
CreatureAI* GetAI_npc_invar_onearmAI(Creature* pCreature) { return new npc_invar_onearmAI(pCreature); }


struct npc_arellas_fireleafAI : public ScriptedAI
{
    explicit npc_arellas_fireleafAI(Creature* pCreature) : ScriptedAI(pCreature) { npc_arellas_fireleafAI::Reset(); }
...
CreatureAI* GetAI_npc_arellas_fireleafAI(Creature* pCreature) { return new npc_arellas_fireleafAI(pCreature); }


struct npc_holia_sunshieldAI : public ScriptedAI
{
    explicit npc_holia_sunshieldAI(Creature* pCreature) : ScriptedAI(pCreature) { npc_holia_sunshieldAI::Reset(); }
...
CreatureAI* GetAI_npc_holia_sunshieldAI(Creature* pCreature) { return new npc_holia_sunshieldAI(pCreature); }


struct npc_ferren_marcusAI : public ScriptedAI
{
    explicit npc_ferren_marcusAI(Creature* pCreature) : ScriptedAI(pCreature) { npc_ferren_marcusAI::Reset(); }
...
CreatureAI* GetAI_npc_ferren_marcusAI(Creature* pCreature) { return new npc_ferren_marcusAI(pCreature); }


struct npc_yana_bloodspearAI : public ScriptedAI
{
    explicit npc_yana_bloodspearAI(Creature* pCreature) : ScriptedAI(pCreature) { npc_yana_bloodspearAI::Reset(); }
...
CreatureAI* GetAI_npc_yana_bloodspearAI(Creature* pCreature) { return new npc_yana_bloodspearAI(pCreature); }


struct npc_orman_stromgardeAI : public ScriptedAI
{
    explicit npc_orman_stromgardeAI(Creature* pCreature) : ScriptedAI(pCreature) { npc_orman_stromgardeAI::Reset(); }
...
CreatureAI* GetAI_npc_orman_stromgardeAI(Creature* pCreature) { return new npc_orman_stromgardeAI(pCreature); }


struct npc_fellari_swiftarrowAI : public ScriptedAI
{
    explicit npc_fellari_swiftarrowAI(Creature* pCreature) : ScriptedAI(pCreature) { npc_fellari_swiftarrowAI::Reset(); }
...
CreatureAI* GetAI_npc_fellari_swiftarrowAI(Creature* pCreature) { return new npc_fellari_swiftarrowAI(pCreature); }


struct npc_dorgar_stoenbrowAI : public ScriptedAI
{
    explicit npc_dorgar_stoenbrowAI(Creature* pCreature) : ScriptedAI(pCreature) { npc_dorgar_stoenbrowAI::Reset(); }
...
CreatureAI* GetAI_npc_dorgar_stoenbrowAI(Creature* pCreature) { return new npc_dorgar_stoenbrowAI(pCreature); }


struct npc_valea_twinbladesAI : public ScriptedAI
{
    explicit npc_valea_twinbladesAI(Creature* pCreature) : ScriptedAI(pCreature) { npc_valea_twinbladesAI::Reset(); }
...
CreatureAI* GetAI_npc_valea_twinbladesAI(Creature* pCreature) { return new npc_valea_twinbladesAI(pCreature); }


struct npc_harthal_truesightAI : public ScriptedAI
{
    explicit npc_harthal_truesightAI(Creature* pCreature) : ScriptedAI(pCreature) { npc_harthal_truesightAI::Reset(); }
...
CreatureAI* GetAI_npc_harthal_truesightAI(Creature* pCreature) { return new npc_harthal_truesightAI(pCreature); }


struct npc_admiral_barean_westwindAI : public ScriptedAI
{
    explicit npc_admiral_barean_westwindAI(Creature* pCreature) : ScriptedAI(pCreature) { npc_admiral_barean_westwindAI::Reset(); }
...
CreatureAI* GetAI_npc_admiral_barean_westwindAI(Creature* pCreature) { return new npc_admiral_barean_westwindAI(pCreature); }
