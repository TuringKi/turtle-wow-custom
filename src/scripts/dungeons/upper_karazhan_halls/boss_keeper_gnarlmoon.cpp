...
{
    boss_keeper_gnarlmoonAI(Creature* pCreature) : ScriptedAI(pCreature) { Reset(); }
...
CreatureAI* GetAI_boss_keeper_gnarlmoon(Creature* pCreature) { return new boss_keeper_gnarlmoonAI(pCreature); }

struct npc_blood_ravenAI : public ScriptedAI
{
    npc_blood_ravenAI(Creature* pCreature) : ScriptedAI(pCreature) { Reset(); }
...
CreatureAI* GetAI_npc_blood_raven(Creature* pCreature) { return new npc_blood_ravenAI(pCreature); }
