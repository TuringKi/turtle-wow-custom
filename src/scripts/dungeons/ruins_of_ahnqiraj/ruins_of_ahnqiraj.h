...
std::array<SpawnLocations, 11> const CrystalSpawn = {{{-9407.164062f, 1959.240845f, 85.558998f}, // central spawn, not initially spawned since it was a nerfed mechanic added in 1.11
