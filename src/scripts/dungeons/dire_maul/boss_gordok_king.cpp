...
CreatureAI* GetAI_boss_king_gordok(Creature* pCreature) { return new boss_king_gordokAI(pCreature); }
...
struct boss_chorushAI : public ScriptedAI
{
    ...
    void Reset() override
    {
        ...
        {
        case SET_MAGE:
            m_creature->LoadEquipment(MAGE_EQUIPMENT, true);
            SetCombatMovement(true);
            break;
        case SET_SHAMAN:
            m_creature->LoadEquipment(SHAMAN_EQUIPMENT, true);
            SetCombatMovement(true);
            break;
        case SET_PRIST:
            m_creature->LoadEquipment(PRIST_EQUIPMENT, true);
            SetCombatMovement(true);
            break;
        }
    }
...
CreatureAI* GetAI_boss_chorush(Creature* pCreature) { return new boss_chorushAI(pCreature); }
