...
const sGossipMenuItems sKromcrushGossips[4] = {{6913, "Um, I'm taking some prisoners we found outside before the king for punishment."}, {6915, "Er... that's how I found them. I wanted to show the king that they were a threat. Say Captain... I overhead Guard Fengus calling you a fat, useless knoll lover. "}, {6914, "So, now that I'm the king... what have you got for me?!"}, {6920, "This sounds like a task worthy of the new king!"}};

const sGossipMenuItems sMizzleGossips[4] = {{6876, "I'm the new king? What are you talking about?"}, {6882, "It's good to be King! Now, let's get back to what you were talking about before..."}, {6895, "Henchmen? Tribute?"}, {6916, "Well then... show me the tribute!"}};
